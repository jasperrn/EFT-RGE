...
res[6,0,6,1]=( + ep * (  - 4*D66[phi1,phi1,phi1,phi1,phi1,phi1] )
       ...
       + l * (  - 20/3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*
         ...
         *delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2 + 
         ...
         40*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^2 + 10*
       ...
       + l^2 * ( 50/3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^2*
         ...
         lam2 + 40/3*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,
         b2,b3,b3]*lam1*lam2^2 - 40/3*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*lam1*lam2^2 + 320/3*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^2 - 50/3*
         delta[b1,phi1,phi1,phi1]*D66[b1,b2,b2,phi1,phi1,phi1]*lam1*lam2 - 110/
         3*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^2*lam2
          + 110/3*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^2*lam2 - 100/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2
         ,b2]*lam1*lam2^2 + 100/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b2,phi1]*lam1*lam2^2 - 320/3*delta[b1,b2,phi1,phi1]*delta[b3,phi1,
         phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^2 - 15*delta[b1,b2,phi1,phi1]
         *D66[b2,b1,phi1,phi1,phi1,phi1]*lam2^2 - 100*delta[b1,b2,phi1,phi1]*
         ...
         D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2^2 + 60*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2 - 50*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^2 - 60*delta[b1
         ,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2 + 210*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^3 + 860/3*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^2 - 
         ...
         phi1.phi1)*lam1^2 + 100/9*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3
          - 100/9*D64[b1,b1,phi1,phi1]*(phi1.phi1)^2*lam1^3 )

       + l^3 * (  - 65/12*delta[phi1,phi1,phi1,phi1]*D66[b2,b2,b1,b1,phi1,phi1
         ]*lam1^2*lam2 - 5/54*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         lam1*lam2^3 - 2045/54*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]
         *lam1^2*lam2^2 - 17525/162*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,
         phi1]*lam1^3*lam2 - 520/9*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,
         phi1]*lam1^3*lam2*z3 + 5/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1
         ,phi1]*N*lam1^3*lam2 + 5/54*delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1
         ,phi1]*lam1*lam2^3 + 2045/54*delta[phi1,phi1,phi1,phi1]*D64[b1,b1,
         ...
         D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^3*lam2 + 35/9*delta[phi1,phi1,phi1,
         phi1]*D64[b2,b2,b1,b1]*(phi1.phi1)*lam1^3*lam2 + 1045/162*delta[phi1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^2*lam2^2 - 1045/162*
         delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b2,b1,b1]*lam1^2*lam2^2
          - 665/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2
         ,b3,b3]*lam1*lam2^3 - 1385/18*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^2 - 70/81*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^2*lam2^2 + 665/
         27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]
         *lam1*lam2^3 + 1385/18*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^2 + 70/81*delta[b1,phi1,phi1,phi1]
         *delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^2*lam2^2 - 40/9*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         lam2^4 - 5215/18*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[
         b1,b3,b2,phi1]*lam1*lam2^3 - 440*delta[b1,phi1,phi1,phi1]*delta[b2,b3
         ,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^3*z3 - 22690/27*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^2*
         lam2^2 - 760*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,
         b3,b2,phi1]*lam1^2*lam2^2*z3 - 985/54*delta[b1,phi1,phi1,phi1]*delta[
         b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*lam2^2 + 5/9*delta[b1,
         ...
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1*lam2^3 + 410/3*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^2*lam2^2
          + 29170/81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*
         lam1^3*lam2 + 1880/9*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^3*lam2*z3 + 305/162*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*N*lam1^3*lam2 + 20/27*delta[b1,phi1,phi1,phi1
         ]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1*lam2^3 - 410/3*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^2*lam2^2 - 29170/81*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2
          - 1880/9*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^3*lam2*z3 - 305/162*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*
         (phi1.phi1)*N*lam1^3*lam2 + 85*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*lam1*lam2^3 + 6025/18*delta[b1,phi1,phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^2 + 160*delta[b1,phi1,phi1,phi1
         ,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^2*z3 - 65/9*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^2*lam2^2 - 85*delta[b1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^3 - 6025/18*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^2
          - 160*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*
         lam2^2*z3 + 65/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1
         ...
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^2 - 5/3*
         ...
         phi1]*D64[b1,b2,b3,phi1]*lam2^4 + 5215/18*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^3 + 440*delta[
         b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*
         lam2^3*z3 + 22690/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*lam1^2*lam2^2 + 760*delta[b1,b2,phi1,phi1]*delta[
         b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^2*lam2^2*z3 + 985/54*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*
         ...
         D66[b2,b1,b4,b3,phi1,phi1]*lam1*lam2^2 + 1070/9*delta[b1,b2,phi1,phi1
          ...
          - 1070/9*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,
         b3]*(phi1.phi1)*lam1^2*lam2^2 + 435/8*delta[b1,b2,phi1,phi1]*D66[b2,
         ...
         phi1.phi1)*lam1^2*lam2 - 3070/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1
         ,phi1]*(phi1.phi1)*lam1*lam2^3 - 6485/9*delta[b1,b2,phi1,phi1]*D64[b1
         ,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^2 - 80*delta[b1,b2,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^2*z3 - 15845/54*delta[b1
         ,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2 + 160/3*
         ...
         *lam1^3*lam2 + 1385/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^3*lam2 + 3070/9*delta[b1,b2,phi1,phi1]*D64[b2,phi1,
         b1,phi1]*(phi1.phi1)*lam1*lam2^3 + 6485/9*delta[b1,b2,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^2 + 80*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^2*z3 + 15845/54*delta[
         b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2 - 160/3
         *delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2*
         z3 - 245/54*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N
         *lam1^3*lam2 - 1385/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^3*lam2 + 4315/18*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b1,b2,b3,b4]*lam1*lam2^3 - 4315/18*delta[
         b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*
         lam1*lam2^3 + 805/12*delta[b1,b2,phi1,phi1,phi1,phi1]*D66[b2,b1,b3,b3
         ,phi1,phi1]*lam1*lam2^2 - 18235/18*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam2^4 - 720*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam2^4*z3 - 51335/18*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^3 - 1880*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^3*z3 - 51290/27*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^2 - 1080*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^2*
         z3 - 430/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*
         lam1^2*lam2^2 + 1105/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3
         ,b3]*(phi1.phi1)*lam1^2*lam2^2 + 18235/18*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*lam2^4 + 720*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*lam2^4*z3 + 51335/18*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*lam2^3 + 1880*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*lam2^3*z3 + 51290/27*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^2 + 1080*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^2*
         z3 + 430/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*
         lam1^2*lam2^2 - 1105/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1
         ,b3]*(phi1.phi1)*lam1^2*lam2^2 - 1090/27*delta[b1,b2,phi1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1*lam2^3 + 1090/27*delta[b1,b2,
         phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1*lam2^3 + 260/3*
         delta[b1,b2,b3,phi1]*delta[b4,phi1,phi1,phi1]*D66[b3,b2,b1,b4,phi1,
         phi1]*lam1*lam2^2 + 135/2*delta[b1,b2,b3,phi1]*D66[b3,b2,b1,phi1,phi1
         ,phi1]*(phi1.phi1)*lam1*lam2^2 + 2675/9*delta[b1,b2,b3,phi1]*D66[b3,
         b2,b1,phi1,phi1,phi1]*(phi1.phi1)*lam1^2*lam2 + 80*delta[b1,b2,b3,
         phi1]*D66[b3,b2,b1,phi1,phi1,phi1]*(phi1.phi1)*lam1^2*lam2*z3 + 295/2
         *delta[b1,b2,b3,phi1,phi1,phi1]*D66[b3,b2,b1,phi1,phi1,phi1]*lam2^3
          + 240*delta[b1,b2,b3,phi1,phi1,phi1]*D66[b3,b2,b1,phi1,phi1,phi1]*
         lam2^3*z3 + 7640/9*delta[b1,b2,b3,phi1,phi1,phi1]*D66[b3,b2,b1,phi1,
         phi1,phi1]*lam1*lam2^2 + 480*delta[b1,b2,b3,phi1,phi1,phi1]*D66[b3,b2
         ,b1,phi1,phi1,phi1]*lam1*lam2^2*z3 + 5/9*delta[b1,b2,b3,b4]*delta[
         phi1,phi1,phi1,phi1]*D66[b4,b3,b2,b1,phi1,phi1]*lam1*lam2^2 + 85/36*
         delta[b1,b2,b3,b4]*D66[b4,b3,b2,b1,phi1,phi1]*(phi1.phi1)^2*lam1^2*
         lam2 - 10/3*delta[b1,b2,b3,b4,phi1,phi1]*delta[b5,phi1,phi1,phi1]*
         D66[b4,b3,b2,b1,b5,phi1]*lam2^3 + 1225/12*delta[b1,b2,b3,b4,phi1,phi1
         ]*D66[b4,b3,b2,b1,phi1,phi1]*(phi1.phi1)*lam1*lam2^2 + 1915/6*delta[
         b1,b2,b3,b4,phi1,phi1,phi1,phi1]*D66[b4,b3,b2,b1,phi1,phi1]*lam2^3 - 
         3/8*D66[phi1,phi1,phi1,phi1,phi1,phi1]*lam2^3 + 61/8*D66[phi1,phi1,
         phi1,phi1,phi1,phi1]*lam1*lam2^2 + 469/6*D66[phi1,phi1,phi1,phi1,phi1
         ,phi1]*lam1^2*lam2 + 80*D66[phi1,phi1,phi1,phi1,phi1,phi1]*lam1^2*
         lam2*z3 + 3451/18*D66[phi1,phi1,phi1,phi1,phi1,phi1]*lam1^3 + 1120/9*
         D66[phi1,phi1,phi1,phi1,phi1,phi1]*lam1^3*z3 - 21/8*D66[phi1,phi1,
         phi1,phi1,phi1,phi1]*N*lam1^2*lam2 + 65/6*D66[phi1,phi1,phi1,phi1,
         phi1,phi1]*N*lam1^3 + 80/9*D66[phi1,phi1,phi1,phi1,phi1,phi1]*N*
         ...
         phi1.phi1)^2*lam1^3 + 85/27*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^2
         *lam2^2 - 40*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*lam2 - 8735/81
         *D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^4 - 640/9*D64[b1,phi1,b1,
         phi1]*(phi1.phi1)^2*lam1^4*z3 - 335/81*D64[b1,phi1,b1,phi1]*(
         ...
         phi1.phi1)^2*N*lam1^4 - 425/81*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^4
       ...
       + l^4 * ( 70/9*delta[phi1,phi1,phi1,phi1]*D66[b2,b2,b1,b1,phi1,phi1]*
         ...
         *delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^4 - 20/3*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^4*z3 + 
         34025/324*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^2*
         lam2^3 - 200/3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^2
         *lam2^3*z4 + 220/3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         lam1^2*lam2^3*z3 + 129725/243*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,
         b1,phi1]*lam1^3*lam2^2 + 5600/9*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*lam1^3*lam2^2*z5 - 2560/9*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*lam1^3*lam2^2*z4 + 18020/27*delta[phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b1,phi1]*lam1^3*lam2^2*z3 + 804455/972*delta[phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2 + 35200/27*delta[
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2*z5 - 3340/27*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2*z4 + 
         16520/81*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2*
         z3 - 1415/324*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*
         lam1^3*lam2^2 - 100/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1
         ]*N*lam1^3*lam2^2*z3 + 4655/2916*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*N*lam1^4*lam2 + 800/81*delta[phi1,phi1,phi1,phi1]*D64[
         b1,phi1,b1,phi1]*N*lam1^4*lam2*z5 - 710/27*delta[phi1,phi1,phi1,phi1]
         *D64[b1,phi1,b1,phi1]*N*lam1^4*lam2*z4 + 2150/27*delta[phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^4*lam2*z3 + 2185/1944*delta[phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^4*lam2 - 130/81*delta[
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^4*lam2*z3 - 355/27
         ...
         *lam2^3*z4 - 220/3*delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1]*
         ...
         1944*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^3*
         lam2^2 + 530/27*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*lam1^3*lam2^2*z3 + 984745/8748*delta[phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2 + 7600/81*delta[phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2*z5 - 260/9*delta[
         phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2*z4 + 
         200/9*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*
         lam2*z3 + 85/729*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*N*lam1^4*lam2 - 130/81*delta[phi1,phi1,phi1,phi1]*D64[b1,
         b2,b1,b2]*(phi1.phi1)*N*lam1^4*lam2*z3 + 39235/1944*delta[phi1,phi1,
         ...
         *z3 - 99865/1944*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2
         ]*lam1^2*lam2^3 + 250/9*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b1,b2]*lam1^2*lam2^3*z3 + 239255/8748*delta[phi1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*lam2^2 - 200/9*delta[phi1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*lam2^2*z4 + 860/27*
         delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*lam2^2*
         z3 + 7895/2916*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*
         N*lam1^3*lam2^2 - 100/27*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b1,b2]*N*lam1^3*lam2^2*z3 + 99865/1944*delta[phi1,phi1,phi1,phi1,
         ...
         *lam2^2*z4 - 860/27*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b2,b1
         ...
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1*lam2^4
          + 160/3*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,
         b3,b3]*lam1*lam2^4*z3 + 143285/324*delta[b1,phi1,phi1,phi1]*delta[b2,
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^3 - 110/3*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^3*z4
          + 3670/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2
         ,b3,b3]*lam1^2*lam2^3*z3 + 1406705/2916*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^2 - 10000/27*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*
         lam1^3*lam2^2*z5 - 150*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^2*z4 + 30530/27*delta[b1,phi1,phi1
         ,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^2*z3 - 
         ...
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^2 + 100/27*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*
         lam2^2*z3 - 685/1458*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1
         ]*D64[b1,b2,b3,b3]*N^2*lam1^3*lam2^2 - 4055/54*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1*lam2^4 - 160/3*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*
         lam1*lam2^4*z3 - 143285/324*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^3 + 110/3*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^3*z4 - 
         3670/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2
         ,b3]*lam1^2*lam2^3*z3 - 1406705/2916*delta[b1,phi1,phi1,phi1]*delta[
         b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^2 + 10000/27*delta[b1
         ,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*
         lam2^2*z5 + 150*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*
         D64[b1,b3,b2,b3]*lam1^3*lam2^2*z4 - 30530/27*delta[b1,phi1,phi1,phi1]
         *delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^2*z3 + 230/81*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*
         lam1^2*lam2^3 - 44675/2187*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^3*lam2^2 - 100/27*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^3*lam2^2*
         z3 + 685/1458*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b3,b2,b3]*N^2*lam1^3*lam2^2 + 880/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam2^5 + 1015/108*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^4
          + 8800/3*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,
         b2,phi1]*lam1*lam2^4*z5 - 760*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^4*z4 + 11000/3*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^4*z3
          + 302885/81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,
         b3,b2,phi1]*lam1^2*lam2^3 + 113200/9*delta[b1,phi1,phi1,phi1]*delta[
         b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^2*lam2^3*z5 - 4270/3*delta[
         b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^2*
         lam2^3*z4 + 97270/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*lam1^2*lam2^3*z3 + 272605/54*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*lam2^2 + 
         370400/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,
         b2,phi1]*lam1^3*lam2^2*z5 - 640/3*delta[b1,phi1,phi1,phi1]*delta[b2,
         b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*lam2^2*z4 + 190840/27*delta[
         b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*
         lam2^2*z3 - 5705/324*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*N*lam1^2*lam2^3 - 110/3*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*lam2^3*z4 + 850/9*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*
         lam1^2*lam2^3*z3 + 4595/18*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,
         phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^2 + 8800/27*delta[b1,phi1,phi1
         ,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^2*z5
          - 340/3*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2
         ,phi1]*N*lam1^3*lam2^2*z4 + 5300/27*delta[b1,phi1,phi1,phi1]*delta[b2
         ,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^2*z3 - 70/27*delta[b1
         ,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^3
         *lam2^2 + 20/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1
         ,b3,b2,phi1]*N^2*lam1^3*lam2^2*z3 - 5/9*delta[b1,phi1,phi1,phi1]*
         ...
         *lam1^3*lam2*z3 + 5/18*delta[b1,phi1,phi1,phi1]*D66[b1,b3,b3,b2,b2,
         ...
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1*lam2^4 - 30475/81
         *delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^2*
         lam2^3 - 3260/9*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^2*lam2^3*z3 - 1472465/486*delta[b1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^2 - 15200/9*delta[b1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^2*z5 + 860/3*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^2
         *z4 - 1380*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*
         lam1^3*lam2^2*z3 - 9219425/2916*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,
         b2,b2]*(phi1.phi1)*lam1^4*lam2 - 128800/27*delta[b1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2*z5 - 560/9*delta[b1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2*z4 + 100/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2*
         z3 + 2215/162*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)
         *N*lam1^3*lam2^2 - 260/27*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]
         *(phi1.phi1)*N*lam1^3*lam2^2*z3 - 750725/8748*delta[b1,phi1,phi1,phi1
         ]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*lam2 - 8800/81*delta[b1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*lam2*z5 + 470/
         9*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*
         lam2*z4 - 3970/27*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N*lam1^4*lam2*z3 + 595/5832*delta[b1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^4*lam2 + 70/81*delta[b1,phi1,phi1
         ,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^4*lam2*z3 - 20/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1*lam2^4
          + 30475/81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^2*lam2^3 + 3260/9*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*lam1^2*lam2^3*z3 + 1472465/486*delta[b1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^2 + 15200/9*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^2*z5 - 860/3*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^2
         *z4 + 1380*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^3*lam2^2*z3 + 9219425/2916*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2
         ,phi1]*(phi1.phi1)*lam1^4*lam2 + 128800/27*delta[b1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2*z5 + 560/9*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2*z4 - 100/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2*
         z3 - 2215/162*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)
         *N*lam1^3*lam2^2 + 260/27*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]
         *(phi1.phi1)*N*lam1^3*lam2^2*z3 + 750725/8748*delta[b1,phi1,phi1,phi1
         ]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*lam2 + 8800/81*delta[b1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*lam2*z5 - 470/
         9*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*
         lam2*z4 + 3970/27*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N*lam1^4*lam2*z3 - 595/5832*delta[b1,phi1,phi1,phi1]*D64[
         b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^4*lam2 - 70/81*delta[b1,phi1,phi1
         ,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^4*lam2*z3 - 15*delta[
         ...
         phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^4 + 360*delta[b1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^4*z4 - 500*delta[b1,phi1
         ,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^4*z3 - 1024175/324
         *delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^3
          - 6400/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         lam1^2*lam2^3*z5 + 1010*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*lam1^2*lam2^3*z4 - 3970/3*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^3*z3 - 1244705/324*delta[b1,phi1
         ,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^2 - 40400/9*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^2*
         z5 + 350*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3
         *lam2^2*z4 - 530/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,
         b2]*lam1^3*lam2^2*z3 + 325/12*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*N*lam1^2*lam2^3 - 20/3*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*N*lam1^2*lam2^3*z3 + 48665/972*delta[b1,phi1
         ,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^2 + 40*delta[
         b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^2*z4 - 
         980/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*
         lam2^2*z3 - 145/108*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2
         ,b2]*N^2*lam1^3*lam2^2 + 20/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*N^2*lam1^3*lam2^2*z3 + 34595/108*delta[b1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^4 - 360*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^4*z4 + 500*delta[b1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^4*z3 + 
         1024175/324*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*
         lam1^2*lam2^3 + 6400/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,
         b2,phi1]*lam1^2*lam2^3*z5 - 1010*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*lam1^2*lam2^3*z4 + 3970/3*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^3*z3 + 1244705/324*delta[b1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^3*lam2^2 + 40400/9
         *delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^3*lam2^2*
         z5 - 350*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^3
         *lam2^2*z4 + 530/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*lam1^3*lam2^2*z3 - 325/12*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*N*lam1^2*lam2^3 + 20/3*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^2*lam2^3*z3 - 48665/972*delta[b1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^3*lam2^2 - 40*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^3*lam2^2
         *z4 + 980/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*
         lam1^3*lam2^2*z3 + 145/108*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*N^2*lam1^3*lam2^2 - 20/9*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*N^2*lam1^3*lam2^2*z3 + 3505/324*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^3
          + 60*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b3,
         b3]*lam1^2*lam2^3*z4 - 400/3*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,
         phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^3*z3 - 313975/972*delta[b1,b2
         ,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^2
          - 15200/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b1,
         b2,b3,b3]*lam1^3*lam2^2*z5 + 100*delta[b1,b2,phi1,phi1]*delta[phi1,
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^2*z4 + 920/27*delta[b1,
         b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*
         lam2^2*z3 + 1525/243*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1
         ]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^2 - 40/9*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^2*z3 - 3505/
         324*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3
         ]*lam1^2*lam2^3 - 60*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1
         ]*D64[b2,b3,b1,b3]*lam1^2*lam2^3*z4 + 400/3*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^3*z3 + 313975/
         972*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3
         ]*lam1^3*lam2^2 + 15200/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^2*z5 - 100*delta[b1,b2,phi1,
         phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^2*z4 - 
         920/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1
         ,b3]*lam1^3*lam2^2*z3 - 1525/243*delta[b1,b2,phi1,phi1]*delta[phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^2 + 40/9*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*
         ...
         phi1,phi1]*D64[b1,b2,b3,phi1]*lam2^5 - 1015/108*delta[b1,b2,phi1,phi1
         ]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^4 - 8800/3*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         lam1*lam2^4*z5 + 760*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*lam1*lam2^4*z4 - 11000/3*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^4*z3 - 302885/
         81*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]
         *lam1^2*lam2^3 - 113200/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*lam1^2*lam2^3*z5 + 4270/3*delta[b1,b2,phi1,
         phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^2*lam2^3*z4 - 
         97270/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,
         phi1]*lam1^2*lam2^3*z3 - 272605/54*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^2 - 370400/27*delta[b1
         ,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*
         lam2^2*z5 + 640/3*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*lam1^3*lam2^2*z4 - 190840/27*delta[b1,b2,phi1,phi1
         ]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^2*z3 + 5705/
         324*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1
         ]*N*lam1^2*lam2^3 + 110/3*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^3*z4 - 850/9*delta[b1,b2,phi1,
         phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^3*z3
          - 4595/18*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,
         b3,phi1]*N*lam1^3*lam2^2 - 8800/27*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3*lam2^2*z5 + 340/3*delta[
         b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3
         *lam2^2*z4 - 5300/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*N*lam1^3*lam2^2*z3 + 70/27*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^3*lam2^2 - 20/9*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         ...
         z3 + 72955/108*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,
         b4,b1,b3]*(phi1.phi1)*lam1^2*lam2^3 + 180*delta[b1,b2,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^2*lam2^3*z4
          + 320*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]
         *(phi1.phi1)*lam1^2*lam2^3*z3 + 41905/36*delta[b1,b2,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^3*lam2^2 + 
         ...
         b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^3*lam2^2*z4 + 1040/9*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^2*z3 + 3355/108*delta[b1,b2,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^3*lam2^2 - 20/3*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         ...
         *delta[b1,b2,phi1,phi1]*D66[b2,b1,phi1,phi1,phi1,phi1]*lam1^3*lam2*z5
         ...
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2^4
          + 420*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*
         lam2^4*z4 + 210*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1*lam2^4*z3 + 216995/27*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^3 + 1600*delta[b1,b2,phi1,phi1]
         *D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^3*z5 + 620*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^3*z4 + 3160/3
         *delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*
         lam2^3*z3 + 2816585/324*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1^3*lam2^2 + 22400/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*lam1^3*lam2^2*z5 - 1220/3*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^2*z4 + 10220/9*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^2
         *z3 + 235300/81*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1^4*lam2 - 46400/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*lam1^4*lam2*z5 - 6340/9*delta[b1,b2,phi1,phi1]
         *D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2*z4 + 16060/27*delta[b1,
         b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2*z3 + 12575/
         162*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*
         lam2^2 - 20/3*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)
         *N*lam1^3*lam2^2*z4 + 40/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1
         ]*(phi1.phi1)*N*lam1^3*lam2^2*z3 - 6905/162*delta[b1,b2,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*lam2 - 440/9*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*lam2*z4 + 1420/
         27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*
         lam2*z3 - 35/36*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N^2*lam1^4*lam2 - 20/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2*z3 - 56785/324*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^3*lam2^2 - 700/9*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^3*lam2^2*
         z3 - 1359935/2916*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^4*lam2 - 22400/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         b3,b3]*(phi1.phi1)^2*lam1^4*lam2*z5 - 260/3*delta[b1,b2,phi1,phi1]*
         D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^4*lam2*z4 + 1720/9*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^4*lam2*z3 - 4295/486*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^4*lam2
          - 100/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*
         lam1^4*lam2*z3 - 436685/216*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*(phi1.phi1)*lam1*lam2^4 - 420*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^4*z4 - 210*delta[b1,b2,phi1,phi1]
         *D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^4*z3 - 216995/27*delta[b1
         ,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^3 - 1600*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^3
         *z5 - 620*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^2*lam2^3*z4 - 3160/3*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *(phi1.phi1)*lam1^2*lam2^3*z3 - 2816585/324*delta[b1,b2,phi1,phi1]*
         D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^2 - 22400/9*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^2*z5 + 1220/3
         *delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*
         lam2^2*z4 - 10220/9*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*lam1^3*lam2^2*z3 - 235300/81*delta[b1,b2,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2 + 46400/27*delta[b1,b2,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2*z5 + 6340/9*delta[
         b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2*z4 - 
         16060/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^4*lam2*z3 - 12575/162*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1
         ]*(phi1.phi1)*N*lam1^3*lam2^2 + 20/3*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*lam2^2*z4 - 40/9*delta[b1,b2,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*lam2^2*z3 + 6905/162*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^4*lam2
          + 440/9*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*
         lam1^4*lam2*z4 - 1420/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         (phi1.phi1)*N*lam1^4*lam2*z3 + 35/36*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2 + 20/9*delta[b1,b2,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2*z3 + 56785/324
         *delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^3*lam2^2
          + 700/9*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^3
         *lam2^2*z3 + 1359935/2916*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^4*lam2 + 22400/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,
         b1,b3]*(phi1.phi1)^2*lam1^4*lam2*z5 + 260/3*delta[b1,b2,phi1,phi1]*
         D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^4*lam2*z4 - 1720/9*delta[b1,b2,
         phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^4*lam2*z3 + 4295/486*
         delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^4*lam2
          + 100/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*
         ...
         *lam2^3*z3 + 30580/27*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^4 + 480*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^4*z4 + 
         1340*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,
         b4,b1,b3]*lam1*lam2^4*z3 + 61970/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^3 + 29600/9*
         delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,
         b3]*lam1^2*lam2^3*z5 + 920*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,
         b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^3*z4 + 7900/9*delta[b1,b2,
         phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*
         lam2^3*z3 + 2735/108*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^2*lam2^3 - 40/3*delta[b1,b2,phi1,
         phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^2*
         ...
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^5 + 9600*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^5*z5 - 
         1500*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^5*z4
          + 6210*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^5*
         z3 + 23545*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1
         *lam2^4 + 109600/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*lam1*lam2^4*z5 - 5440*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*lam1*lam2^4*z4 + 24040*delta[b1,b2,phi1,phi1,phi1,phi1]
         *D64[b1,b2,phi1,phi1]*lam1*lam2^4*z3 + 5307455/162*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^3 + 420400/9*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^3*z5 - 
         20230/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*
         lam2^3*z4 + 91330/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*lam1^2*lam2^3*z3 + 29985/2*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam1^3*lam2^2 + 450400/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^3*lam2^2*z5 - 26680/9*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^3*lam2^2*z4 + 
         344260/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         lam1^3*lam2^2*z3 + 10525/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*N*lam1^2*lam2^3 - 470/3*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^3*z4 + 1970/9*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^3*z3 + 25595/162*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^2
          + 13600/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*
         lam1^3*lam2^2*z5 - 2180/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*N*lam1^3*lam2^2*z4 + 1520/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^2*z3 - 235/324*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^3*lam2^2 - 20/9*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^3*
         lam2^2*z3 + 25645/324*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,
         b3]*(phi1.phi1)*lam1^2*lam2^3 - 160/3*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^2*lam2^3*z3 - 107675/243*delta[b1
         ,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^2
          - 41600/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*lam1^3*lam2^2*z5 - 680/3*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^2*z4 + 25700/27*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^2*z3 + 
         3995/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*N*lam1^3*lam2^2 - 200/9*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b3,b3]*(phi1.phi1)*N*lam1^3*lam2^2*z3 - 1188205/216*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^5 - 9600*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^5*z5 + 1500*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^5*z4 - 
         6210*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^5*z3
          - 23545*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*
         lam2^4 - 109600/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*lam1*lam2^4*z5 + 5440*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*lam1*lam2^4*z4 - 24040*delta[b1,b2,phi1,phi1,phi1,phi1]
         *D64[b2,phi1,b1,phi1]*lam1*lam2^4*z3 - 5307455/162*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^3 - 420400/9*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^3*z5 + 
         20230/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*
         lam2^3*z4 - 91330/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*lam1^2*lam2^3*z3 - 29985/2*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,phi1,b1,phi1]*lam1^3*lam2^2 - 450400/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^3*lam2^2*z5 + 26680/9*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^3*lam2^2*z4 - 
         344260/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^3*lam2^2*z3 - 10525/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*N*lam1^2*lam2^3 + 470/3*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*N*lam1^2*lam2^3*z4 - 1970/9*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^2*lam2^3*z3 - 25595/162*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^2
          - 13600/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*
         lam1^3*lam2^2*z5 + 2180/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*N*lam1^3*lam2^2*z4 - 1520/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^2*z3 + 235/324*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^3*lam2^2 + 20/9*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^3*
         lam2^2*z3 - 25645/324*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,
         b3]*(phi1.phi1)*lam1^2*lam2^3 + 160/3*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^2*lam2^3*z3 + 107675/243*delta[b1
         ,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^2
          + 41600/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^2*z5 + 680/3*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^2*z4 - 25700/27*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^2*z3 - 
         3995/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*N*lam1^3*lam2^2 + 200/9*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*(phi1.phi1)*N*lam1^3*lam2^2*z3 + 5195/9*delta[b1,b2,
         ...
         lam1*lam2^4 - 80*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3
         ,b1,b3]*lam1*lam2^4*z4 - 1720/3*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*lam1*lam2^4*z3 - 35525/324*delta[b1,b2,phi1,
         phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^3 + 10400/9*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*
         lam2^3*z5 + 160/3*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,
         b3,b1,b3]*lam1^2*lam2^3*z4 - 18080/9*delta[b1,b2,phi1,phi1,phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^3*z3 - 11920/243*delta[b1,b2,
         phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^2*lam2^3 + 320/
         9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*
         ...
         *(phi1.phi1)^2*N*lam1^4*z3 - 1165/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^2*lam2^3 + 20*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*
         lam1^2*lam2^3*z3 + 1435/81*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*
         lam2^2 - 80/3*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*lam2^2*z4 + 
         580/9*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*lam2^2*z3 + 2085055/
         2916*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^4*lam2 + 1600/3*D64[b1,
         phi1,b1,phi1]*(phi1.phi1)^2*lam1^4*lam2*z5 - 80*D64[b1,phi1,b1,phi1]*
         (phi1.phi1)^2*lam1^4*lam2*z4 + 12880/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2*z3 + 370195/486*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5 + 13600/9*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*
         lam1^5*z5 + 320/9*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^5*z4 + 1040/
         27*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^5*z3 - 125/54*D64[b1,phi1,
         b1,phi1]*(phi1.phi1)^2*N*lam1^4*lam2 + 140/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^4*lam2*z3 + 66935/972*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5 + 1600/27*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N*
         lam1^5*z5 - 160/9*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N*lam1^5*z4 + 
         2020/27*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N*lam1^5*z3 + 335/2916*
         D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N^2*lam1^5 + 1165/27*D64[b1,b1,
         ...
         *lam1^5*z4 - 2020/27*D64[b1,b1,phi1,phi1]*(phi1.phi1)^2*N*lam1^5*z3
         ...
         D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^4*lam2 + 10/9*D64[b1,b2,b1,b2]*(
         phi1.phi1)^3*lam1^4*lam2*z3 + 26855/486*D64[b1,b2,b1,b2]*(
         phi1.phi1)^3*lam1^5 + 2000/27*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*
         z5 - 220/27*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*z3 + 4195/2916*D64[
         b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^5 - 4015/324*D64[b2,b2,b1,b1]*(
       ...
       + l^5 * ( 110195/5184*delta[phi1,phi1,phi1,phi1]*D66[b2,b2,b1,b1,phi1,
         ...
         *delta[phi1,phi1,phi1,phi1]*D66[b2,b2,b1,b1,phi1,phi1]*N*lam1^4*lam2*
         ...
         1728*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^5 + 80/
         3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^5*z5 - 35/
         2*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^5*z4 + 
         425/12*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1*lam2^5*z3
          - 551965/864*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^2*
         lam2^4 + 10250/9*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         lam1^2*lam2^4*z6 - 18295/9*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,
         phi1]*lam1^2*lam2^4*z5 + 1790/3*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*lam1^2*lam2^4*z4 - 4195/18*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*lam1^2*lam2^4*z3 + 3140/9*delta[phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b1,phi1]*lam1^2*lam2^4*z3^2 - 133452055/46656*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^3*lam2^3 - 18865/
         3*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^3*lam2^3*z7 + 
         167125/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^3*
         lam2^3*z6 - 97160/9*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         lam1^3*lam2^3*z5 + 123065/36*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,
         b1,phi1]*lam1^3*lam2^3*z4 - 634865/162*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*lam1^3*lam2^3*z3 + 41050/27*delta[phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b1,phi1]*lam1^3*lam2^3*z3^2 - 569384225/69984*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2^2 - 
         252490/9*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*
         lam2^2*z7 + 279250/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]
         *lam1^4*lam2^2*z6 - 1325890/81*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1
         ,b1,phi1]*lam1^4*lam2^2*z5 + 154745/36*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*lam1^4*lam2^2*z4 - 2098415/324*delta[phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2^2*z3 + 5900/9*delta[phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^4*lam2^2*z3^2 - 159446015/
         23328*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^5*lam2 - 
         744940/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*lam1^5*lam2
         *z7 + 284000/81*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         lam1^5*lam2*z6 - 163780/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,
         phi1]*lam1^5*lam2*z5 + 77635/54*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*lam1^5*lam2*z4 - 125350/243*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*lam1^5*lam2*z3 + 10280/81*delta[phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b1,phi1]*lam1^5*lam2*z3^2 + 134345/15552*delta[phi1
         ,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^3*lam2^3 - 1690/27*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^3*lam2^3*z5 + 
         325/18*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^3*
         lam2^3*z4 - 1705/324*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*
         N*lam1^3*lam2^3*z3 + 955205/17496*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*N*lam1^4*lam2^2 + 24250/81*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*N*lam1^4*lam2^2*z6 - 2510/3*delta[phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^4*lam2^2*z5 + 320*delta[phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^4*lam2^2*z4 - 405/2*delta[phi1
         ,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^4*lam2^2*z3 + 6220/81*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^4*lam2^2*z3^2
          - 1591865/11664*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*
         lam1^5*lam2 - 31850/27*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1
         ]*N*lam1^5*lam2*z7 + 204625/243*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*N*lam1^5*lam2*z6 - 102115/81*delta[phi1,phi1,phi1,phi1]
         *D64[b1,phi1,b1,phi1]*N*lam1^5*lam2*z5 + 83875/324*delta[phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^5*lam2*z4 - 189125/324*delta[
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^5*lam2*z3 + 3250/243
         *delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N*lam1^5*lam2*z3^2
          + 565/2592*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*
         lam1^4*lam2^2 - 175/54*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1
         ]*N^2*lam1^4*lam2^2*z4 + 215/54*delta[phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b1,phi1]*N^2*lam1^4*lam2^2*z3 - 3954625/419904*delta[phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^5*lam2 + 500/243*delta[phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^5*lam2*z6 - 5360/243*
         delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^5*lam2*z5 + 
         2005/81*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2*lam1^5*
         lam2*z4 - 395/972*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^2
         *lam1^5*lam2*z3 + 200/243*delta[phi1,phi1,phi1,phi1]*D64[b1,phi1,b1,
         phi1]*N^2*lam1^5*lam2*z3^2 + 4405/15552*delta[phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b1,phi1]*N^3*lam1^5*lam2 - 95/162*delta[phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b1,phi1]*N^3*lam1^5*lam2*z4 + 35/108*delta[phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b1,phi1]*N^3*lam1^5*lam2*z3 + 132095/1728
         *delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1]*lam1*lam2^5 - 80/3*
         delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1]*lam1*lam2^5*z5 + 35/2
         *delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1]*lam1*lam2^5*z4 - 425/
         12*delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1]*lam1*lam2^5*z3 + 
         ...
         *lam1^5*lam2 - 500/243*delta[phi1,phi1,phi1,phi1]*D64[b1,b1,phi1,phi1
         ...
         lam1^5*lam2*z3 + 34432085/139968*delta[phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b1,b2]*(phi1.phi1)*lam1^3*lam2^3 - 50*delta[phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^3*lam2^3*z5 + 95/2*delta[phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^3*lam2^3*z4 - 87035/324*
         delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^3*lam2^3
         *z3 - 75014525/419904*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*lam1^4*lam2^2 + 52750/81*delta[phi1,phi1,phi1,phi1]*D64[b1
         ,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2^2*z6 - 175910/81*delta[phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2^2*z5 + 1705/12*
         delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2^2
         *z4 - 35120/81*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*lam1^4*lam2^2*z3 + 28900/81*delta[phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^4*lam2^2*z3^2 - 756352505/629856*
         delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^5*lam2
          - 241990/81*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*
         lam1^5*lam2*z7 + 147250/243*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,
         b2]*(phi1.phi1)*lam1^5*lam2*z6 - 107210/81*delta[phi1,phi1,phi1,phi1]
         *D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^5*lam2*z5 + 15665/108*delta[phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^5*lam2*z4 - 3815/36
         *delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*lam1^5*lam2*
         z3 + 141220/243*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*lam1^5*lam2*z3^2 - 481735/69984*delta[phi1,phi1,phi1,phi1]
         *D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^4*lam2^2 + 485/54*delta[phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^4*lam2^2*z4 + 310/
         81*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3 + 768955/629856*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]
         *(phi1.phi1)*N*lam1^5*lam2 + 16250/243*delta[phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^5*lam2*z6 - 15140/81*delta[phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^5*lam2*z5 + 3575/
         162*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^5*
         lam2*z4 + 4585/486*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         phi1.phi1)*N*lam1^5*lam2*z3 + 3260/243*delta[phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*(phi1.phi1)*N*lam1^5*lam2*z3^2 - 1535/34992*delta[
         phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N^2*lam1^5*lam2 - 
         95/162*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(phi1.phi1)*N^2*
         lam1^5*lam2*z4 + 85/81*delta[phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*(
         ...
         *z4 + 87035/324*delta[phi1,phi1,phi1,phi1]*D64[b2,b2,b1,b1]*(
         ...
         D64[b1,b2,b1,b2]*lam1^2*lam2^4 - 1330/9*delta[phi1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*lam1^2*lam2^4*z5 + 215/12*delta[phi1,phi1
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^2*lam2^4*z4 - 35075/108*
         delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^2*lam2^4*
         z3 + 47348635/209952*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,
         b1,b2]*lam1^3*lam2^3 + 4750/9*delta[phi1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*lam1^3*lam2^3*z6 - 27470/27*delta[phi1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*lam2^3*z5 + 245/6*delta[phi1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*lam2^3*z4 - 33695/
         81*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^3*
         lam2^3*z3 + 860/3*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,
         b2]*lam1^3*lam2^3*z3^2 - 262155095/314928*delta[phi1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b1,b2]*lam1^4*lam2^2 - 12110/9*delta[phi1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^4*lam2^2*z7 + 16250/27*
         delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^4*lam2^2*
         z6 - 55760/81*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*
         lam1^4*lam2^2*z5 + 18605/324*delta[phi1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b1,b2]*lam1^4*lam2^2*z4 - 32815/324*delta[phi1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^4*lam2^2*z3 + 15700/27*delta[
         phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*lam1^4*lam2^2*z3^2 - 
         1198535/69984*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N
         *lam1^3*lam2^3 + 100/9*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b1,b2]*N*lam1^3*lam2^3*z4 + 265/81*delta[phi1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b1,b2]*N*lam1^3*lam2^3*z3 - 1820695/157464*delta[phi1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N*lam1^4*lam2^2 - 800/81*
         delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N*lam1^4*lam2^2
         *z5 + 455/27*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N*
         lam1^4*lam2^2*z4 + 7130/243*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,b2,b1,b2]*N*lam1^4*lam2^2*z3 + 52645/69984*delta[phi1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N^2*lam1^4*lam2^2 - 25/18*delta[phi1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N^2*lam1^4*lam2^2*z4 + 95/
         162*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b1,b2]*N^2*lam1^4*
         ...
         *lam1^3*lam2^3 - 4750/9*delta[phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,
         ...
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1*lam2^5 - 1600/3*delta[
         b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1*
         lam2^5*z5 + 90*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b2,b3,b3]*lam1*lam2^5*z4 - 1000/3*delta[b1,phi1,phi1,phi1]*delta[
         b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1*lam2^5*z3 - 49573945/23328*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*
         lam1^2*lam2^4 + 2750/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^4*z6 - 44590/9*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^4*z5 + 
         ...
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*lam2^4*z3 - 220/9*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^2*
         lam2^4*z3^2 - 216537485/69984*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^3 + 76265/9*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^3*z7
          + 29000/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,
         b2,b3,b3]*lam1^3*lam2^3*z6 - 440200/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^3*z5 + 186175/
         54*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]
         *lam1^3*lam2^3*z4 - 1260530/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1
         ,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*lam2^3*z3 - 27040/27*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^3*
         lam2^3*z3^2 - 387337405/209952*delta[b1,phi1,phi1,phi1]*delta[b2,phi1
         ,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^4*lam2^2 + 14175*delta[b1,phi1,phi1
         ,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^4*lam2^2*z7 + 
         ...
         b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^4*lam2^2*z5 + 78205/36*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*
         lam1^4*lam2^2*z4 - 4626265/324*delta[b1,phi1,phi1,phi1]*delta[b2,phi1
         ,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^4*lam2^2*z3 - 106960/81*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*lam1^4*
         lam2^2*z3^2 + 81925/8748*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b2,b3,b3]*N*lam1^2*lam2^4 + 20/3*delta[b1,phi1,phi1,phi1
         ]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^2*lam2^4*z4 - 20/3
         *delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N
         *lam1^2*lam2^4*z3 - 16127005/209952*delta[b1,phi1,phi1,phi1]*delta[b2
         ,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^3 - 60*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^3*
         z5 + 185/2*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,
         b2,b3,b3]*N*lam1^3*lam2^3*z4 - 2210/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^3*lam2^3*z3 - 
         35827555/157464*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*
         D64[b1,b2,b3,b3]*N*lam1^4*lam2^2 + 2695/9*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^4*lam2^2*z7 - 4250/
         81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]
         *N*lam1^4*lam2^2*z6 - 34805/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1
         ,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^4*lam2^2*z5 + 29135/81*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^4*
         lam2^2*z4 - 48730/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1
         ]*D64[b1,b2,b3,b3]*N*lam1^4*lam2^2*z3 - 3980/81*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N*lam1^4*lam2^2*z3^2
          - 59765/69984*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b2,b3,b3]*N^2*lam1^3*lam2^3 + 25/18*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N^2*lam1^3*lam2^3*z3 + 
         5436175/1259712*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*
         D64[b1,b2,b3,b3]*N^2*lam1^4*lam2^2 + 25/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N^2*lam1^4*lam2^2*z4 - 3355/
         972*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3
         ]*N^2*lam1^4*lam2^2*z3 - 5735/52488*delta[b1,phi1,phi1,phi1]*delta[b2
         ,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N^3*lam1^4*lam2^2 + 10/81*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*N^3*lam1^4*
         lam2^2*z3 + 4226095/11664*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1
         ,phi1]*D64[b1,b3,b2,b3]*lam1*lam2^5 + 1600/3*delta[b1,phi1,phi1,phi1]
         *delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1*lam2^5*z5 - 90*delta[
         b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1*
         lam2^5*z4 + 1000/3*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*
         D64[b1,b3,b2,b3]*lam1*lam2^5*z3 + 49573945/23328*delta[b1,phi1,phi1,
         phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^4 - 2750/
         9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*
         lam1^2*lam2^4*z6 + 44590/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^4*z5 - 10325/9*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^4*z4
          + 88900/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,
         b3,b2,b3]*lam1^2*lam2^4*z3 + 220/9*delta[b1,phi1,phi1,phi1]*delta[b2,
         phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^2*lam2^4*z3^2 + 216537485/69984
         *delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*
         lam1^3*lam2^3 - 76265/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^3*z7 - 29000/27*delta[b1,phi1,phi1
         ,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^3*z6 + 
         440200/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3
         ,b2,b3]*lam1^3*lam2^3*z5 - 186175/54*delta[b1,phi1,phi1,phi1]*delta[
         b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^3*z4 + 1260530/81*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*
         lam1^3*lam2^3*z3 + 27040/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*lam1^3*lam2^3*z3^2 + 387337405/209952*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*
         lam1^4*lam2^2 - 14175*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,
         phi1]*D64[b1,b3,b2,b3]*lam1^4*lam2^2*z7 - 234500/81*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^4*lam2^2*z6
          + 1504645/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b3,b2,b3]*lam1^4*lam2^2*z5 - 78205/36*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^4*lam2^2*z4 + 4626265/
         324*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3
         ]*lam1^4*lam2^2*z3 + 106960/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1
         ,phi1,phi1]*D64[b1,b3,b2,b3]*lam1^4*lam2^2*z3^2 - 81925/8748*delta[b1
         ,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^2*
         lam2^4 - 20/3*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b3,b2,b3]*N*lam1^2*lam2^4*z4 + 20/3*delta[b1,phi1,phi1,phi1]*
         delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^2*lam2^4*z3 + 
         16127005/209952*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*
         D64[b1,b3,b2,b3]*N*lam1^3*lam2^3 + 60*delta[b1,phi1,phi1,phi1]*delta[
         b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^3*lam2^3*z5 - 185/2*delta[
         b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^3
         *lam2^3*z4 + 2210/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1
         ]*D64[b1,b3,b2,b3]*N*lam1^3*lam2^3*z3 + 35827555/157464*delta[b1,phi1
         ,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^4*lam2^2
          - 2695/9*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3
         ,b2,b3]*N*lam1^4*lam2^2*z7 + 4250/81*delta[b1,phi1,phi1,phi1]*delta[
         b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^4*lam2^2*z6 + 34805/81*
         delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*
         lam1^4*lam2^2*z5 - 29135/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,
         phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^4*lam2^2*z4 + 48730/81*delta[b1,
         phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N*lam1^4*
         lam2^2*z3 + 3980/81*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]
         *D64[b1,b3,b2,b3]*N*lam1^4*lam2^2*z3^2 + 59765/69984*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N^2*lam1^3*
         lam2^3 - 25/18*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b3,b2,b3]*N^2*lam1^3*lam2^3*z3 - 5436175/1259712*delta[b1,phi1,
         phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N^2*lam1^4*
         lam2^2 - 25/27*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[
         b1,b3,b2,b3]*N^2*lam1^4*lam2^2*z4 + 3355/972*delta[b1,phi1,phi1,phi1]
         *delta[b2,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N^2*lam1^4*lam2^2*z3 + 
         5735/52488*delta[b1,phi1,phi1,phi1]*delta[b2,phi1,phi1,phi1]*D64[b1,
         b3,b2,b3]*N^3*lam1^4*lam2^2 - 10/81*delta[b1,phi1,phi1,phi1]*delta[b2
         ,phi1,phi1,phi1]*D64[b1,b3,b2,b3]*N^3*lam1^4*lam2^2*z3 - 22115/108*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         lam2^6 - 100*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,
         b3,b2,phi1]*lam2^6*z3 + 328765/81*delta[b1,phi1,phi1,phi1]*delta[b2,
         b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^5 - 24255*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^5*z7
          + 25750/3*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,
         b2,phi1]*lam1*lam2^5*z6 - 92405/3*delta[b1,phi1,phi1,phi1]*delta[b2,
         b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^5*z5 + 34165/4*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^5
         *z4 - 710435/36*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[
         b1,b3,b2,phi1]*lam1*lam2^5*z3 - 11420/3*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1*lam2^5*z3^2 + 693865/
         81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]
         *lam1^2*lam2^4 - 149940*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,
         phi1]*D64[b1,b3,b2,phi1]*lam1^2*lam2^4*z7 + 39250*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^2*lam2^4*z6 - 
         442870/3*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2
         ,phi1]*lam1^2*lam2^4*z5 + 313895/12*delta[b1,phi1,phi1,phi1]*delta[b2
         ,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^2*lam2^4*z4 - 10379105/108*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         lam1^2*lam2^4*z3 - 19340*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,
         phi1]*D64[b1,b3,b2,phi1]*lam1^2*lam2^4*z3^2 - 172686695/7776*delta[b1
         ,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*
         lam2^3 - 3226580/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*lam1^3*lam2^3*z7 + 1340750/27*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*lam2^3*z6 - 
         1974520/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,
         b2,phi1]*lam1^3*lam2^3*z5 + 188965/9*delta[b1,phi1,phi1,phi1]*delta[
         b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*lam2^3*z4 - 7026985/54*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         lam1^3*lam2^3*z3 - 1072660/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^3*lam2^3*z3^2 - 14317135/648*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         lam1^4*lam2^2 - 7012600/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,
         phi1]*D64[b1,b3,b2,phi1]*lam1^4*lam2^2*z7 + 352000/27*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^4*lam2^2*z6
          - 7361150/81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,
         b3,b2,phi1]*lam1^4*lam2^2*z5 + 42935/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^4*lam2^2*z4 - 4941200/
         81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]
         *lam1^4*lam2^2*z3 - 694120/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*lam1^4*lam2^2*z3^2 - 6145/162*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*
         lam2^4 + 2750/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[
         b1,b3,b2,phi1]*N*lam1^2*lam2^4*z6 - 630*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*lam2^4*z5 + 405*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*
         lam1^2*lam2^4*z4 - 18635/54*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1
         ,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*lam2^4*z3 - 220/9*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^2*lam2^4*
         z3^2 - 410695/2592*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*N*lam1^3*lam2^3 - 5390/3*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^3*z7 + 92500/
         27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]
         *N*lam1^3*lam2^3*z6 - 205870/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^3*z5 + 32725/18*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*
         lam2^3*z4 - 65270/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*N*lam1^3*lam2^3*z3 + 15160/27*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^3*lam2^3*z3^2
          - 6780325/2592*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[
         b1,b3,b2,phi1]*N*lam1^4*lam2^2 - 309260/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^4*lam2^2*z7 + 38750/
         9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         N*lam1^4*lam2^2*z6 - 870470/81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^4*lam2^2*z5 + 91055/54*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^4*
         lam2^2*z4 - 211300/81*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]
         *D64[b1,b3,b2,phi1]*N*lam1^4*lam2^2*z3 + 4460/27*delta[b1,phi1,phi1,
         phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N*lam1^4*lam2^2*z3^2
          - 25655/15552*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1
         ,b3,b2,phi1]*N^2*lam1^3*lam2^3 - 385/27*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^3*lam2^3*z5 + 665/
         36*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]
         *N^2*lam1^3*lam2^3*z4 - 100/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,
         phi1,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^3*lam2^3*z3 + 36775/2592*
         delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*
         N^2*lam1^4*lam2^2 + 2750/27*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1
         ,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^4*lam2^2*z6 - 5950/27*delta[b1,
         phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^4*
         lam2^2*z5 + 1205/36*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*N^2*lam1^4*lam2^2*z4 - 14525/324*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^2*lam1^4*
         lam2^2*z3 + 220/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*
         D64[b1,b3,b2,phi1]*N^2*lam1^4*lam2^2*z3^2 - 715/1728*delta[b1,phi1,
         phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^3*lam1^4*
         lam2^2 + 5/9*delta[b1,phi1,phi1,phi1]*delta[b2,b3,phi1,phi1]*D64[b1,
         b3,b2,phi1]*N^3*lam1^4*lam2^2*z4 + 5/324*delta[b1,phi1,phi1,phi1]*
         delta[b2,b3,phi1,phi1]*D64[b1,b3,b2,phi1]*N^3*lam1^4*lam2^2*z3 - 155/
         ...
         *delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1*lam2^5
          - 10/3*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1*
         lam2^5*z3 + 8986355/5832*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         (phi1.phi1)*lam1^2*lam2^4 + 20045/9*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*lam1^2*lam2^4*z5 - 2695/6*delta[b1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^2*lam2^4*z4 + 130795/54*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^2*lam2^4
         *z3 + 146804345/7776*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^3*lam2^3 + 115745/9*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^3*z7 - 4750*delta[b1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^3*z6 + 531905/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^3
         *z5 - 115445/36*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^3*lam2^3*z4 + 3900155/324*delta[b1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^3*z3 - 8380/9*delta[b1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^3*lam2^3*z3^2 + 
         211677605/4374*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^4*lam2^2 + 2573900/27*delta[b1,phi1,phi1,phi1]*D64[b1
         ,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2^2*z7 - 341000/27*delta[b1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2^2*z6 + 2428960/
         81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*
         lam2^2*z5 - 169675/54*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^4*lam2^2*z4 + 6550*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2^2*z3 - 8920/9*delta[b1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^4*lam2^2*z3^2 + 3032345855/
         104976*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^5
         *lam2 + 8535310/81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^5*lam2*z7 - 168500/81*delta[b1,phi1,phi1,phi1]*D64[b1
         ,phi1,b2,b2]*(phi1.phi1)*lam1^5*lam2*z6 + 350480/81*delta[b1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^5*lam2*z5 - 3890/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*lam1^5*lam2*
         z4 - 1473140/243*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*lam1^5*lam2*z3 + 72880/81*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*lam1^5*lam2*z3^2 - 11112355/139968*delta[b1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^3*lam2^3 + 550/
         9*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^3*
         lam2^3*z5 - 505/9*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N*lam1^3*lam2^3*z4 + 5425/36*delta[b1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^3*lam2^3*z3 + 1826125/209952*delta[
         b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*lam2^2 - 
         64750/81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*
         lam1^4*lam2^2*z6 + 219710/81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,
         b2]*(phi1.phi1)*N*lam1^4*lam2^2*z5 - 15995/36*delta[b1,phi1,phi1,phi1
         ]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*lam2^2*z4 + 142025/324*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3 - 11140/81*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N*lam1^4*lam2^2*z3^2 + 828503395/629856*delta[b1,phi1,phi1
         ,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^5*lam2 + 470960/81*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^5*lam2
         *z7 - 487000/243*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N*lam1^5*lam2*z6 + 926560/243*delta[b1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^5*lam2*z5 - 8630/81*delta[b1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*lam1^5*lam2*z4 + 
         74695/243*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N*
         lam1^5*lam2*z3 - 75160/243*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2
         ]*(phi1.phi1)*N*lam1^5*lam2*z3^2 + 393685/139968*delta[b1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^4*lam2^2 - 95/54*delta[
         b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^4*lam2^2*
         z4 - 15/4*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2
         *lam1^4*lam2^2*z3 - 4625/39366*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,
         b2,b2]*(phi1.phi1)*N^2*lam1^5*lam2 - 11000/243*delta[b1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^5*lam2*z6 + 32620/243*
         delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^5*
         lam2*z5 - 5915/162*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N^2*lam1^5*lam2*z4 + 1625/486*delta[b1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^5*lam2*z3 - 1760/243*delta[b1
         ,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^2*lam1^5*lam2*z3^2
          - 1735/209952*delta[b1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*(
         phi1.phi1)*N^3*lam1^5*lam2 + 35/162*delta[b1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*(phi1.phi1)*N^3*lam1^5*lam2*z4 - 55/162*delta[b1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*(phi1.phi1)*N^3*lam1^5*lam2*z3 - 155/
         216*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1*
         lam2^5 + 10/3*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)
         *lam1*lam2^5*z3 - 8986355/5832*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*(phi1.phi1)*lam1^2*lam2^4 - 20045/9*delta[b1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^2*lam2^4*z5 + 2695/6*delta[b1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^2*lam2^4*z4 - 
         130795/54*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^2*lam2^4*z3 - 146804345/7776*delta[b1,phi1,phi1,phi1]*D64[b1,b2,
         b2,phi1]*(phi1.phi1)*lam1^3*lam2^3 - 115745/9*delta[b1,phi1,phi1,phi1
         ]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^3*z7 + 4750*delta[b1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^3*z6 - 
         531905/27*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*
         lam1^3*lam2^3*z5 + 115445/36*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*(phi1.phi1)*lam1^3*lam2^3*z4 - 3900155/324*delta[b1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3 + 8380/9*delta[
         b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3^2
          - 211677605/4374*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*lam1^4*lam2^2 - 2573900/27*delta[b1,phi1,phi1,phi1]*D64[b1
         ,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2^2*z7 + 341000/27*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2^2*z6 - 2428960/
         81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*
         lam2^2*z5 + 169675/54*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*lam1^4*lam2^2*z4 - 6550*delta[b1,phi1,phi1,phi1]*D64[b1,b2
         ,b2,phi1]*(phi1.phi1)*lam1^4*lam2^2*z3 + 8920/9*delta[b1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^4*lam2^2*z3^2 - 3032345855/
         104976*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^5
         *lam2 - 8535310/81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*lam1^5*lam2*z7 + 168500/81*delta[b1,phi1,phi1,phi1]*D64[b1
         ,b2,b2,phi1]*(phi1.phi1)*lam1^5*lam2*z6 - 350480/81*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^5*lam2*z5 + 3890/27*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*lam1^5*lam2*
         z4 + 1473140/243*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*lam1^5*lam2*z3 - 72880/81*delta[b1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*(phi1.phi1)*lam1^5*lam2*z3^2 + 11112355/139968*delta[b1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^3*lam2^3 - 550/
         9*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^3*
         lam2^3*z5 + 505/9*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N*lam1^3*lam2^3*z4 - 5425/36*delta[b1,phi1,phi1,phi1]*D64[
         b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^3*lam2^3*z3 - 1826125/209952*delta[
         b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*lam2^2 + 
         64750/81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*
         lam1^4*lam2^2*z6 - 219710/81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z5 + 15995/36*delta[b1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z4 - 142025/324*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3 + 11140/81*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N*lam1^4*lam2^2*z3^2 - 828503395/629856*delta[b1,phi1,phi1
         ,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^5*lam2 - 470960/81*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^5*lam2
         *z7 + 487000/243*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N*lam1^5*lam2*z6 - 926560/243*delta[b1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^5*lam2*z5 + 8630/81*delta[b1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*lam1^5*lam2*z4 - 
         74695/243*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N*
         lam1^5*lam2*z3 + 75160/243*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1
         ]*(phi1.phi1)*N*lam1^5*lam2*z3^2 - 393685/139968*delta[b1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2 + 95/54*delta[
         b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2*
         z4 + 15/4*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2
         *lam1^4*lam2^2*z3 + 4625/39366*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*(phi1.phi1)*N^2*lam1^5*lam2 + 11000/243*delta[b1,phi1,phi1,phi1
         ]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z6 - 32620/243*
         delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^5*
         lam2*z5 + 5915/162*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N^2*lam1^5*lam2*z4 - 1625/486*delta[b1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z3 + 1760/243*delta[b1
         ,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z3^2
          + 1735/209952*delta[b1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*(
         phi1.phi1)*N^3*lam1^5*lam2 - 35/162*delta[b1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*(phi1.phi1)*N^3*lam1^5*lam2*z4 + 55/162*delta[b1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*(phi1.phi1)*N^3*lam1^5*lam2*z3 - 12725/
         ...
         *D66[b1,b3,b3,b2,b2,phi1]*lam1^2*lam2^3*z4 - 25/6*delta[b1,phi1,phi1,
         ...
         lam2^2*z3 + 288985/144*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1
         ,b2,b2]*lam1*lam2^5 - 7000*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*lam1*lam2^5*z6 + 8700*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*lam1*lam2^5*z5 - 8095/2*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^5*z4 + 28265/6*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^5*z3 - 2320*delta[
         b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1*lam2^5*z3^2 + 
         644155/24*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         lam1^2*lam2^4 + 90580/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*lam1^2*lam2^4*z7 - 90250/3*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^4*z6 + 117380/3*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^4*z5 - 45865/3*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^2*lam2^4*
         z4 + 324385/18*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         lam1^2*lam2^4*z3 - 24700/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*lam1^2*lam2^4*z3^2 + 258659695/3888*delta[b1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^3 + 1118705/9*delta[b1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^3*z7 - 
         369500/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3
         *lam2^3*z6 + 468940/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,
         b2,b2]*lam1^3*lam2^3*z5 - 614395/36*delta[b1,phi1,phi1,phi1,phi1,phi1
         ]*D64[b1,phi1,b2,b2]*lam1^3*lam2^3*z4 + 1557025/108*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^3*z3 - 77720/9*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^3*lam2^3*
         z3^2 + 1011448295/23328*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*lam1^4*lam2^2 + 3147025/27*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,phi1,b2,b2]*lam1^4*lam2^2*z7 - 327500/27*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^4*lam2^2*z6 + 395995/27*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^4*lam2^2*
         z5 - 214505/36*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         lam1^4*lam2^2*z4 - 963055/324*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*lam1^4*lam2^2*z3 - 59600/27*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,phi1,b2,b2]*lam1^4*lam2^2*z3^2 - 90695/1296*delta[
         b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^2*lam2^4 + 140
         *delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^2*
         lam2^4*z5 - 135/2*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,
         b2]*N*lam1^2*lam2^4*z4 + 655/6*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*N*lam1^2*lam2^4*z3 - 1476275/1944*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^3 - 2000/3*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^3
         *z6 + 12280/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N
         *lam1^3*lam2^3*z5 - 795/2*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*N*lam1^3*lam2^3*z4 + 7745/27*delta[b1,phi1,phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^3*z3 - 160*delta[b1,phi1,phi1
         ,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^3*lam2^3*z3^2 - 7635725/
         34992*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^4*
         lam2^2 + 7595/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]
         *N*lam1^4*lam2^2*z7 - 51250/27*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*N*lam1^4*lam2^2*z6 + 21935/9*delta[b1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^4*lam2^2*z5 - 4775/27*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N*lam1^4*lam2^2
         *z4 + 40865/54*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         N*lam1^4*lam2^2*z3 - 8380/27*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,phi1,b2,b2]*N*lam1^4*lam2^2*z3^2 + 895/288*delta[b1,phi1,phi1,phi1
         ,phi1,phi1]*D64[b1,phi1,b2,b2]*N^2*lam1^3*lam2^3 - 65/18*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N^2*lam1^3*lam2^3*z3 + 
         746845/46656*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*
         N^2*lam1^4*lam2^2 + 80/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         phi1,b2,b2]*N^2*lam1^4*lam2^2*z5 - 245/9*delta[b1,phi1,phi1,phi1,phi1
         ,phi1]*D64[b1,phi1,b2,b2]*N^2*lam1^4*lam2^2*z4 - 7625/324*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N^2*lam1^4*lam2^2*z3 - 
         305/1296*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2,b2]*N^3*
         lam1^4*lam2^2 + 5/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,phi1,b2
         ,b2]*N^3*lam1^4*lam2^2*z4 - 25/81*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,phi1,b2,b2]*N^3*lam1^4*lam2^2*z3 - 288985/144*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^5 + 7000*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^5*z6 - 8700*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*lam2^5*z5
          + 8095/2*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1*
         lam2^5*z4 - 28265/6*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*lam1*lam2^5*z3 + 2320*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1
         ,b2,b2,phi1]*lam1*lam2^5*z3^2 - 644155/24*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^4 - 90580/3*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^4*z7 + 90250/3*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^4*
         z6 - 117380/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*
         lam1^2*lam2^4*z5 + 45865/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*lam1^2*lam2^4*z4 - 324385/18*delta[b1,phi1,phi1,phi1,phi1
         ,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^4*z3 + 24700/3*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^2*lam2^4*z3^2 - 
         258659695/3888*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*
         lam1^3*lam2^3 - 1118705/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*lam1^3*lam2^3*z7 + 369500/9*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*lam1^3*lam2^3*z6 - 468940/9*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^3*lam2^3*z5 + 614395/36*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^3*lam2^3*
         z4 - 1557025/108*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1
         ]*lam1^3*lam2^3*z3 + 77720/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,b2,b2,phi1]*lam1^3*lam2^3*z3^2 - 1011448295/23328*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^4*lam2^2 - 3147025/27*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^4*lam2^2*
         z7 + 327500/27*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*
         lam1^4*lam2^2*z6 - 395995/27*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[
         b1,b2,b2,phi1]*lam1^4*lam2^2*z5 + 214505/36*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^4*lam2^2*z4 + 963055/324*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^4*lam2^2*z3 + 59600/
         27*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*lam1^4*
         lam2^2*z3^2 + 90695/1296*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b2,phi1]*N*lam1^2*lam2^4 - 140*delta[b1,phi1,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b2,phi1]*N*lam1^2*lam2^4*z5 + 135/2*delta[b1,phi1,phi1,phi1
         ,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^2*lam2^4*z4 - 655/6*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^2*lam2^4*z3 + 
         1476275/1944*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*
         lam1^3*lam2^3 + 2000/3*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,
         b2,phi1]*N*lam1^3*lam2^3*z6 - 12280/9*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*N*lam1^3*lam2^3*z5 + 795/2*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^3*lam2^3*z4 - 7745/27*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^3*lam2^3
         *z3 + 160*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*
         lam1^3*lam2^3*z3^2 + 7635725/34992*delta[b1,phi1,phi1,phi1,phi1,phi1]
         *D64[b1,b2,b2,phi1]*N*lam1^4*lam2^2 - 7595/3*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^4*lam2^2*z7 + 51250/27*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^4*lam2^2*z6 - 
         21935/9*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*
         lam1^4*lam2^2*z5 + 4775/27*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,
         b2,b2,phi1]*N*lam1^4*lam2^2*z4 - 40865/54*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^4*lam2^2*z3 + 8380/27*delta[b1,
         phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N*lam1^4*lam2^2*z3^2 - 
         895/288*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N^2*
         lam1^3*lam2^3 + 65/18*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2
         ,phi1]*N^2*lam1^3*lam2^3*z3 - 746845/46656*delta[b1,phi1,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b2,phi1]*N^2*lam1^4*lam2^2 - 80/9*delta[b1,phi1,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N^2*lam1^4*lam2^2*z5 + 245/9*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N^2*lam1^4*
         lam2^2*z4 + 7625/324*delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,
         phi1]*N^2*lam1^4*lam2^2*z3 + 305/1296*delta[b1,phi1,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b2,phi1]*N^3*lam1^4*lam2^2 - 5/9*delta[b1,phi1,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N^3*lam1^4*lam2^2*z4 + 25/81*
         delta[b1,phi1,phi1,phi1,phi1,phi1]*D64[b1,b2,b2,phi1]*N^3*lam1^4*
         ...
         *lam1^4*lam2^2*z3^2 - 52945/3888*delta[b1,b2,phi1,phi1]*delta[phi1,
         ...
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4
          + 500*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1
         ,b3]*lam1^2*lam2^4*z6 - 7795/9*delta[b1,b2,phi1,phi1]*delta[phi1,phi1
         ,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z5 + 2735/4*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*
         z4 - 22555/36*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[
         b2,b3,b1,b3]*lam1^2*lam2^4*z3 - 40*delta[b1,b2,phi1,phi1]*delta[phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z3^2 - 7274425/5184*
         delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*
         lam1^3*lam2^3 - 3185*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1
         ]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*z7 + 3875*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*z6 - 271430/
         27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]
         *lam1^3*lam2^3*z5 + 16405/12*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*z4 + 53015/54*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*
         z3 + 4390/9*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,
         b3,b1,b3]*lam1^3*lam2^3*z3^2 - 43429465/17496*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^4*lam2^2 - 354830/27
         *delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*
         lam1^4*lam2^2*z7 + 64750/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*lam1^4*lam2^2*z6 - 502330/81*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^4*lam2^2*
         z5 + 24560/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[
         b2,b3,b1,b3]*lam1^4*lam2^2*z4 + 66395/54*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^4*lam2^2*z3 + 27820/
         27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]
         *lam1^4*lam2^2*z3^2 + 52945/3888*delta[b1,b2,phi1,phi1]*delta[phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^3 - 140/3*delta[b1,b2,
         phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*
         lam2^3*z5 + 125/3*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*N*lam1^3*lam2^3*z4 + 10/27*delta[b1,b2,phi1,phi1]*
         delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^3*z3 + 
         2661725/34992*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[
         b2,b3,b1,b3]*N*lam1^4*lam2^2 + 7750/27*delta[b1,b2,phi1,phi1]*delta[
         phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^4*lam2^2*z6 - 51410/81*
         delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*
         lam1^4*lam2^2*z5 + 115/9*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*N*lam1^4*lam2^2*z4 + 1240/27*delta[b1,b2,phi1,
         phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^4*lam2^2*z3
          + 100/3*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,
         b1,b3]*N*lam1^4*lam2^2*z3^2 - 475/288*delta[b1,b2,phi1,phi1]*delta[
         phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N^2*lam1^4*lam2^2 + 5/3*delta[
         b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N^2*
         lam1^4*lam2^2*z4 + 20/27*delta[b1,b2,phi1,phi1]*delta[phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*N^2*lam1^4*lam2^2*z3 - 35395/864*delta[b1,b2,
         ...
         *delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D66[b2,b1,b3,b4,b4,
         ...
         b2,b3,phi1]*lam2^6*z3 - 328765/81*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^5 + 24255*delta[b1,b2,
         phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^5*z7
          - 25750/3*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,
         b3,phi1]*lam1*lam2^5*z6 + 92405/3*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^5*z5 - 34165/4*delta[b1,
         b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^5
         *z4 + 710435/36*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[
         b1,b2,b3,phi1]*lam1*lam2^5*z3 + 11420/3*delta[b1,b2,phi1,phi1]*delta[
         b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1*lam2^5*z3^2 - 693865/81*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         lam1^2*lam2^4 + 149940*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1
         ]*D64[b1,b2,b3,phi1]*lam1^2*lam2^4*z7 - 39250*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^2*lam2^4*z6 + 442870/
         3*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         lam1^2*lam2^4*z5 - 313895/12*delta[b1,b2,phi1,phi1]*delta[b3,phi1,
         phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^2*lam2^4*z4 + 10379105/108*delta[
         b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^2*
         lam2^4*z3 + 19340*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*lam1^2*lam2^4*z3^2 + 172686695/7776*delta[b1,b2,
         phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^3
          + 3226580/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,
         b2,b3,phi1]*lam1^3*lam2^3*z7 - 1340750/27*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^3*z6 + 
         1974520/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,
         b3,phi1]*lam1^3*lam2^3*z5 - 188965/9*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^3*z4 + 7026985/54*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         lam1^3*lam2^3*z3 + 1072660/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,
         phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^3*lam2^3*z3^2 + 14317135/648*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         lam1^4*lam2^2 + 7012600/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*lam1^4*lam2^2*z7 - 352000/27*delta[b1,b2,
         phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^4*lam2^2*
         z6 + 7361150/81*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[
         b1,b2,b3,phi1]*lam1^4*lam2^2*z5 - 42935/27*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^4*lam2^2*z4 + 
         4941200/81*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,
         b3,phi1]*lam1^4*lam2^2*z3 + 694120/27*delta[b1,b2,phi1,phi1]*delta[b3
         ,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*lam1^4*lam2^2*z3^2 + 6145/162*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*
         lam1^2*lam2^4 - 2750/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1
         ]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^4*z6 + 630*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^4*z5 - 405*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*
         lam1^2*lam2^4*z4 + 18635/54*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1
         ,phi1]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^4*z3 + 220/9*delta[b1,b2,phi1
         ,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^2*lam2^4*
         z3^2 + 410695/2592*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*
         D64[b1,b2,b3,phi1]*N*lam1^3*lam2^3 + 5390/3*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3*lam2^3*z7 - 
         92500/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3
         ,phi1]*N*lam1^3*lam2^3*z6 + 205870/27*delta[b1,b2,phi1,phi1]*delta[b3
         ,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3*lam2^3*z5 - 32725/18*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*
         lam1^3*lam2^3*z4 + 65270/27*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1
         ,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3*lam2^3*z3 - 15160/27*delta[b1,b2,
         phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^3*
         lam2^3*z3^2 + 6780325/2592*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*N*lam1^4*lam2^2 + 309260/27*delta[b1,b2,phi1
         ,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^4*lam2^2*z7
          - 38750/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,
         b3,phi1]*N*lam1^4*lam2^2*z6 + 870470/81*delta[b1,b2,phi1,phi1]*delta[
         b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^4*lam2^2*z5 - 91055/54*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*
         lam1^4*lam2^2*z4 + 211300/81*delta[b1,b2,phi1,phi1]*delta[b3,phi1,
         phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^4*lam2^2*z3 - 4460/27*delta[b1,
         b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N*lam1^4*
         lam2^2*z3^2 + 25655/15552*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^3*lam2^3 + 385/27*delta[b1,b2,phi1,
         phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^3*lam2^3*
         z5 - 665/36*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2
         ,b3,phi1]*N^2*lam1^3*lam2^3*z4 + 100/27*delta[b1,b2,phi1,phi1]*delta[
         b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^3*lam2^3*z3 - 36775/
         2592*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,
         phi1]*N^2*lam1^4*lam2^2 - 2750/27*delta[b1,b2,phi1,phi1]*delta[b3,
         phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^4*lam2^2*z6 + 5950/27*
         delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*
         N^2*lam1^4*lam2^2*z5 - 1205/36*delta[b1,b2,phi1,phi1]*delta[b3,phi1,
         phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^4*lam2^2*z4 + 14525/324*delta[
         b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^2*
         lam1^4*lam2^2*z3 - 220/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,
         phi1]*D64[b1,b2,b3,phi1]*N^2*lam1^4*lam2^2*z3^2 + 715/1728*delta[b1,
         b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^3*lam1^4*
         lam2^2 - 5/9*delta[b1,b2,phi1,phi1]*delta[b3,phi1,phi1,phi1]*D64[b1,
         b2,b3,phi1]*N^3*lam1^4*lam2^2*z4 - 5/324*delta[b1,b2,phi1,phi1]*
         delta[b3,phi1,phi1,phi1]*D64[b1,b2,b3,phi1]*N^3*lam1^4*lam2^2*z3 + 
         640*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*delta[b5,b6,phi1,
         phi1]*D66[b2,b1,b4,b3,b6,b5]*lam1^2*lam2^3 + 475*delta[b1,b2,phi1,
         phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1*lam2^4
          + 4800*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3
         ,phi1,phi1]*lam1*lam2^4*z5 - 1485*delta[b1,b2,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1*lam2^4*z4 + 2970*delta[b1,
         b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1*
         lam2^4*z3 + 1080*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2
         ,b1,b4,b3,phi1,phi1]*lam1*lam2^4*z3^2 + 6705*delta[b1,b2,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^2*lam2^3 + 
         13230*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,
         phi1,phi1]*lam1^2*lam2^3*z7 - 2500*delta[b1,b2,phi1,phi1]*delta[b3,b4
         ,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^2*lam2^3*z6 + 25300*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,
         phi1]*lam1^2*lam2^3*z5 - 4080*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1
         ,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^2*lam2^3*z4 + 22850*delta[b1,
         b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*
         lam1^2*lam2^3*z3 + 2600*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]
         *D66[b2,b1,b4,b3,phi1,phi1]*lam1^2*lam2^3*z3^2 + 345410/9*delta[b1,b2
         ,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^3*
         lam2^2 + 37660*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,
         b1,b4,b3,phi1,phi1]*lam1^3*lam2^2*z7 - 10000/3*delta[b1,b2,phi1,phi1]
         *delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^3*lam2^2*z6
          + 95000/3*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4
         ,b3,phi1,phi1]*lam1^3*lam2^2*z5 - 2800*delta[b1,b2,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^3*lam2^2*z4 + 28080*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,
         phi1]*lam1^3*lam2^2*z3 + 6560/3*delta[b1,b2,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*lam1^3*lam2^2*z3^2 - 45*delta[
         b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[b2,b1,b4,b3,phi1,phi1]*N*
         lam1^2*lam2^3 - 45*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D66[
         b2,b1,b4,b3,phi1,phi1]*N*lam1^2*lam2^3*z4 + 90*delta[b1,b2,phi1,phi1]
         ...
         *lam2^2*z3^2 + 905/324*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         ...
         b1,b3]*(phi1.phi1)*lam1^2*lam2^4 - 1500*delta[b1,b2,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z6 - 4970/
         3*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*lam1^2*lam2^4*z5 - 2745/2*delta[b1,b2,phi1,phi1]*delta[b3,
         b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z4 - 7935/2*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*lam1^2*lam2^4*z3 - 240*delta[b1,b2,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z3^2 - 13616665/
         1296*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^3 - 20020*delta[b1,b2,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z7 - 4875*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^3*z6 - 127265/9*delta[b1,b2,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z5 - 
         10445/2*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3
         ]*(phi1.phi1)*lam1^3*lam2^3*z4 - 47515/18*delta[b1,b2,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z3
          - 9370/3*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,
         b3]*(phi1.phi1)*lam1^3*lam2^3*z3^2 - 16458385/2592*delta[b1,b2,phi1,
         phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4*
         lam2^2 - 1288210/27*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4*lam2^2*z7 - 64750/9*delta[b1,b2,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4
         *lam2^2*z6 + 6940/9*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4*lam2^2*z5 - 13930/3*delta[b1,b2,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4
         *lam2^2*z4 - 206015/54*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4*lam2^2*z3 - 34420/9*delta[b1,b2,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*lam1^4
         *lam2^2*z3^2 - 905/324*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^3*lam2^3 + 70*delta[b1,b2,phi1,
         phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^3*
         lam2^3*z5 - 55/2*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2
         ,b4,b1,b3]*(phi1.phi1)*N*lam1^3*lam2^3*z4 - 2465/18*delta[b1,b2,phi1,
         phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^3*
         lam2^3*z3 - 1662085/2592*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1
         ]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2 + 1000/9*delta[b1,b2,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*
         lam1^4*lam2^2*z6 - 41990/27*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,
         phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z5 - 665/6*delta[
         b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*
         N*lam1^4*lam2^2*z4 + 20845/54*delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1
         ,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z3 - 400/9*delta[
         b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*
         N*lam1^4*lam2^2*z3^2 + 1475/864*delta[b1,b2,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2 - 5/3*
         delta[b1,b2,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(
         phi1.phi1)*N^2*lam1^4*lam2^2*z4 - 65/54*delta[b1,b2,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2*z3 + 
         ...
         *(phi1.phi1)*N*lam1^4*lam2*z3^2 + 575/576*delta[b1,b2,phi1,phi1]*D66[
         ...
         ,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2^5 - 6750*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2^5*
         z6 - 180*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1
         *lam2^5*z5 - 2925*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1*lam2^5*z4 - 21985/4*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*lam1*lam2^5*z3 + 1620*delta[b1,b2,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1*lam2^5*z3^2 - 178979245/2592*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^4
          - 22050*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*
         lam1^2*lam2^4*z7 - 16750*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         (phi1.phi1)*lam1^2*lam2^4*z6 - 15080*delta[b1,b2,phi1,phi1]*D64[b1,b2
         ,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^4*z5 - 28300/3*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^4*z4 - 48435/2*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^2*lam2^4
         *z3 + 4100*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*
         lam1^2*lam2^4*z3^2 - 26891915/192*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*lam1^3*lam2^3 - 685300/9*delta[b1,b2,phi1,phi1
         ]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z7 - 11875/3*delta[
         b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z6 - 
         435445/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*
         lam1^3*lam2^3*z5 - 141235/36*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*(phi1.phi1)*lam1^3*lam2^3*z4 - 1098095/27*delta[b1,b2,phi1,phi1
         ]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3 + 5230*delta[b1,
         b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3^2 - 
         858256085/7776*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1^4*lam2^2 - 242200/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z7 + 532750/27*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z6 - 1458670/27*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2^2
         *z5 + 209525/18*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1^4*lam2^2*z4 - 1104820/27*delta[b1,b2,phi1,phi1]*D64[
         b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z3 + 313780/27*delta[b1,b2
         ,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z3^2 - 
         89930815/2592*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)
         *lam1^5*lam2 + 3709510/81*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]
         *(phi1.phi1)*lam1^5*lam2*z7 + 124000/9*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*lam1^5*lam2*z6 - 1928600/81*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^5*lam2*z5 + 489955/
         54*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*lam1^5*
         lam2*z4 - 14745*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*lam1^5*lam2*z3 + 211120/27*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*lam1^5*lam2*z3^2 - 53215/96*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3 + 500/3*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*
         lam2^3*z6 - 7600/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N*lam1^3*lam2^3*z5 + 385/6*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3*z4 - 4010/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3*z3 - 40/3
         *delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^3*
         lam2^3*z3^2 - 1675165/864*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]
         *(phi1.phi1)*N*lam1^4*lam2^2 - 3920/3*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z7 + 21500/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z6 - 
         61970/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*
         lam1^4*lam2^2*z5 + 14575/18*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z4 - 15155/18*delta[b1,b2,phi1,phi1
         ]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z3 + 1400/27*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3^2 - 852235/7776*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]
         *(phi1.phi1)*N*lam1^5*lam2 + 164570/81*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z7 + 32875/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z6 - 38255/
         27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^5*
         lam2*z5 + 30985/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N*lam1^5*lam2*z4 - 170390/81*delta[b1,b2,phi1,phi1]*D64[b1
         ,b2,phi1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z3 + 20510/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z3^2 + 6275/
         1944*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^2*
         lam1^4*lam2^2 - 70/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N^2*lam1^4*lam2^2*z5 - 40/9*delta[b1,b2,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2*z4 + 95/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2*z3 + 
         22265/972*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^2
         *lam1^5*lam2 + 500/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N^2*lam1^5*lam2*z6 - 2990/81*delta[b1,b2,phi1,phi1]*D64[b1
         ,b2,phi1,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z5 + 110/3*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z4 + 2620/
         81*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^2*lam1^5
         *lam2*z3 - 40/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(
         phi1.phi1)*N^2*lam1^5*lam2*z3^2 - 65/576*delta[b1,b2,phi1,phi1]*D64[
         b1,b2,phi1,phi1]*(phi1.phi1)*N^3*lam1^5*lam2 - 5/9*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^3*lam1^5*lam2*z4 + 95/108*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,phi1,phi1]*(phi1.phi1)*N^3*lam1^5*
         lam2*z3 + 6037375/46656*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^3*lam2^3 + 3220/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,
         b3,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z5 + 10*delta[b1,b2,phi1,phi1]*
         D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z4 + 83395/108*delta[b1,
         b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z3 + 
         202517215/69984*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2
         *lam1^4*lam2^2 + 17360/3*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^4*lam2^2*z7 - 12500/27*delta[b1,b2,phi1,phi1]*D64[
         b1,b2,b3,b3]*(phi1.phi1)^2*lam1^4*lam2^2*z6 + 228500/27*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^4*lam2^2*z5 + 4250/9*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^4*lam2^2*
         z4 - 57320/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*
         lam1^4*lam2^2*z3 - 6920/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^4*lam2^2*z3^2 + 177124105/69984*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^5*lam2 + 618730/27*delta[b1
         ,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^5*lam2*z7 + 150250/
         81*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^5*lam2*
         z6 - 3430/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*
         lam1^5*lam2*z5 + 25165/36*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*lam1^5*lam2*z4 - 928865/324*delta[b1,b2,phi1,phi1]*D64[
         b1,b2,b3,b3]*(phi1.phi1)^2*lam1^5*lam2*z3 + 580/81*delta[b1,b2,phi1,
         phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*lam1^5*lam2*z3^2 - 383425/7776*
         delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^4*lam2^2
          - 35/9*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*
         lam1^4*lam2^2*z4 + 3955/54*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*N*lam1^4*lam2^2*z3 + 2833435/26244*delta[b1,b2,phi1,phi1
         ]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^5*lam2 - 16000/81*delta[b1,b2
         ,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z6 + 30970/
         27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^5*
         lam2*z5 + 4775/54*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*N*lam1^5*lam2*z4 - 14855/81*delta[b1,b2,phi1,phi1]*D64[
         b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z3 - 4960/81*delta[b1,b2,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z3^2 - 18455/
         69984*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)^2*N^2*
         lam1^5*lam2 - 25/27*delta[b1,b2,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)^2*N^2*lam1^5*lam2*z4 + 85/54*delta[b1,b2,phi1,phi1]*D64[b1
         ,b2,b3,b3]*(phi1.phi1)^2*N^2*lam1^5*lam2*z3 + 20736935/1728*delta[b1,
         b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^5 + 6750*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^5*
         z6 + 180*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1
         *lam2^5*z5 + 2925*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*lam1*lam2^5*z4 + 21985/4*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^5*z3 - 1620*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1*lam2^5*z3^2 + 178979245/2592*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^4
          + 22050*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^2*lam2^4*z7 + 16750*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         (phi1.phi1)*lam1^2*lam2^4*z6 + 15080*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^4*z5 + 28300/3*delta[b1,b2,phi1
         ,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^4*z4 + 48435/2*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^2*lam2^4
         *z3 - 4100*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^2*lam2^4*z3^2 + 26891915/192*delta[b1,b2,phi1,phi1]*D64[b2,phi1,
         b1,phi1]*(phi1.phi1)*lam1^3*lam2^3 + 685300/9*delta[b1,b2,phi1,phi1]*
         D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z7 + 11875/3*delta[b1,
         b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z6 + 
         435445/9*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^3*lam2^3*z5 + 141235/36*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*(phi1.phi1)*lam1^3*lam2^3*z4 + 1098095/27*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3 - 5230*delta[b1,
         b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^3*lam2^3*z3^2 + 
         858256085/7776*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*lam1^4*lam2^2 + 242200/9*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z7 - 532750/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z6 + 
         1458670/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*
         lam1^4*lam2^2*z5 - 209525/18*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*(phi1.phi1)*lam1^4*lam2^2*z4 + 1104820/27*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2^2*z3 - 313780/27*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^4*lam2^2
         *z3^2 + 89930815/2592*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*lam1^5*lam2 - 3709510/81*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*lam1^5*lam2*z7 - 124000/9*delta[b1,b2,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^5*lam2*z6 + 1928600/81*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^5*lam2*
         z5 - 489955/54*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*lam1^5*lam2*z4 + 14745*delta[b1,b2,phi1,phi1]*D64[b2,phi1,
         b1,phi1]*(phi1.phi1)*lam1^5*lam2*z3 - 211120/27*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*lam1^5*lam2*z3^2 + 53215/96*delta[
         b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3 - 
         500/3*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*
         lam1^3*lam2^3*z6 + 7600/9*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *(phi1.phi1)*N*lam1^3*lam2^3*z5 - 385/6*delta[b1,b2,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3*z4 + 4010/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*lam2^3*z3 + 40/3
         *delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^3*
         lam2^3*z3^2 + 1675165/864*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *(phi1.phi1)*N*lam1^4*lam2^2 + 3920/3*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z7 - 21500/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z6 + 
         61970/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*
         lam1^4*lam2^2*z5 - 14575/18*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z4 + 15155/18*delta[b1,b2,phi1,phi1
         ]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^4*lam2^2*z3 - 1400/27*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3^2 + 852235/7776*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *(phi1.phi1)*N*lam1^5*lam2 - 164570/81*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z7 - 32875/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z6 + 38255/
         27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^5*
         lam2*z5 - 30985/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*N*lam1^5*lam2*z4 + 170390/81*delta[b1,b2,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z3 - 20510/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N*lam1^5*lam2*z3^2 - 6275/
         1944*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2*
         lam1^4*lam2^2 + 70/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*N^2*lam1^4*lam2^2*z5 + 40/9*delta[b1,b2,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2*z4 - 95/27*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^4*lam2^2*z3 - 
         22265/972*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2
         *lam1^5*lam2 - 500/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*N^2*lam1^5*lam2*z6 + 2990/81*delta[b1,b2,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z5 - 110/3*delta[b1,b2,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^5*lam2*z4 - 2620/
         81*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^2*lam1^5
         *lam2*z3 + 40/27*delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(
         phi1.phi1)*N^2*lam1^5*lam2*z3^2 + 65/576*delta[b1,b2,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*(phi1.phi1)*N^3*lam1^5*lam2 + 5/9*delta[b1,b2,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^3*lam1^5*lam2*z4 - 95/108*
         delta[b1,b2,phi1,phi1]*D64[b2,phi1,b1,phi1]*(phi1.phi1)*N^3*lam1^5*
         lam2*z3 - 6037375/46656*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^3*lam2^3 - 3220/9*delta[b1,b2,phi1,phi1]*D64[b2,b3,
         b1,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z5 - 10*delta[b1,b2,phi1,phi1]*
         D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z4 - 83395/108*delta[b1,
         b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^3*lam2^3*z3 - 
         202517215/69984*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2
         *lam1^4*lam2^2 - 17360/3*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^4*lam2^2*z7 + 12500/27*delta[b1,b2,phi1,phi1]*D64[
         b2,b3,b1,b3]*(phi1.phi1)^2*lam1^4*lam2^2*z6 - 228500/27*delta[b1,b2,
         phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^4*lam2^2*z5 - 4250/9*
         delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^4*lam2^2*
         z4 + 57320/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*
         lam1^4*lam2^2*z3 + 6920/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^4*lam2^2*z3^2 - 177124105/69984*delta[b1,b2,phi1,
         phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^5*lam2 - 618730/27*delta[b1
         ,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^5*lam2*z7 - 150250/
         81*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^5*lam2*
         z6 + 3430/9*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*
         lam1^5*lam2*z5 - 25165/36*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*lam1^5*lam2*z4 + 928865/324*delta[b1,b2,phi1,phi1]*D64[
         b2,b3,b1,b3]*(phi1.phi1)^2*lam1^5*lam2*z3 - 580/81*delta[b1,b2,phi1,
         phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*lam1^5*lam2*z3^2 + 383425/7776*
         delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^4*lam2^2
          + 35/9*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*
         lam1^4*lam2^2*z4 - 3955/54*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*N*lam1^4*lam2^2*z3 - 2833435/26244*delta[b1,b2,phi1,phi1
         ]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^5*lam2 + 16000/81*delta[b1,b2
         ,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z6 - 30970/
         27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^5*
         lam2*z5 - 4775/54*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*N*lam1^5*lam2*z4 + 14855/81*delta[b1,b2,phi1,phi1]*D64[
         b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z3 + 4960/81*delta[b1,b2,
         phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N*lam1^5*lam2*z3^2 + 18455/
         69984*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)^2*N^2*
         lam1^5*lam2 + 25/27*delta[b1,b2,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)^2*N^2*lam1^5*lam2*z4 - 85/54*delta[b1,b2,phi1,phi1]*D64[b2
         ,b3,b1,b3]*(phi1.phi1)^2*N^2*lam1^5*lam2*z3 + 241865/288*delta[b1,b2,
         ...
         *delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b1,b2,b3
         ...
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^5 - 5250
         *delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1
         ,b3]*lam1*lam2^5*z6 - 36590/3*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[
         b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^5*z5 - 6075/4*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1*
         lam2^5*z4 - 144965/12*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^5*z3 - 3660*delta[b1,b2,phi1,
         phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1*lam2^5*
         z3^2 - 42356555/2592*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,
         phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^4 - 65100*delta[b1,b2,phi1,
         phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^4
         *z7 - 140750/9*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1
         ]*D64[b2,b4,b1,b3]*lam1^2*lam2^4*z6 - 105700/3*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^4*z5
          - 30790/3*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*lam1^2*lam2^4*z4 - 141595/9*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^2*lam2^4*z3
          - 156380/9*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*lam1^2*lam2^4*z3^2 - 13117405/1296*delta[b1,b2,phi1,
         phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^3*lam2^3
          - 1111810/9*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*lam1^3*lam2^3*z7 - 539000/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^3*lam2^3*z6
          + 103120/27*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*lam1^3*lam2^3*z5 - 95215/9*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^3*lam2^3*z4
          - 470080/27*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*
         D64[b2,b4,b1,b3]*lam1^3*lam2^3*z3 - 432080/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*lam1^3*lam2^3*z3^2
          - 68255/1296*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]
         *D64[b2,b4,b1,b3]*N*lam1^2*lam2^4 + 560/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^2*lam2^4*z5 - 15/
         4*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,
         b1,b3]*N*lam1^2*lam2^4*z4 - 965/36*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^2*lam2^4*z3 - 767975/
         864*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4
         ,b1,b3]*N*lam1^3*lam2^3 + 8000/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^3*lam2^3*z6 - 55720/27
         *delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1
         ,b3]*N*lam1^3*lam2^3*z5 - 1985/18*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^3*lam2^3*z4 + 24115/27
         *delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4,b1
         ,b3]*N*lam1^3*lam2^3*z3 - 2080/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N*lam1^3*lam2^3*z3^2 + 43805/
         5184*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,
         b4,b1,b3]*N^2*lam1^3*lam2^3 - 10/3*delta[b1,b2,phi1,phi1,phi1,phi1]*
         delta[b3,b4,phi1,phi1]*D64[b2,b4,b1,b3]*N^2*lam1^3*lam2^3*z4 - 295/
         108*delta[b1,b2,phi1,phi1,phi1,phi1]*delta[b3,b4,phi1,phi1]*D64[b2,b4
         ,b1,b3]*N^2*lam1^3*lam2^3*z3 + 526645/108*delta[b1,b2,phi1,phi1,phi1,
         ...
         *delta[b1,b2,phi1,phi1,phi1,phi1]*D66[b2,b1,b3,b3,phi1,phi1]*lam1^3*
         ...
         b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^6 - 132300*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^6*z7 + 
         34500*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^6*z6
          - 98680*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam2^6
         *z5 + 30375/2*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         lam2^6*z4 - 147145/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*lam2^6*z3 - 4680*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*lam2^6*z3^2 - 472029785/2592*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^5 - 655235*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^5*z7 + 496000/3*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^5*z6 - 1487125/
         3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^5*
         z5 + 293175/4*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         lam1*lam2^5*z4 - 2990885/12*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*lam1*lam2^5*z3 - 79640/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*lam1*lam2^5*z3^2 - 113183915/288*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^4 - 3728620/
         3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^4
         *z7 + 301500*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         lam1^2*lam2^4*z6 - 8440630/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,
         b2,phi1,phi1]*lam1^2*lam2^4*z5 + 543385/4*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^4*z4 - 17363615/36*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^4*z3 - 154600/
         3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^2*lam2^4
         *z3^2 - 2874119305/7776*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,
         phi1,phi1]*lam1^3*lam2^3 - 1005830*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam1^3*lam2^3*z7 + 6701750/27*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^3*lam2^3*z6 - 21295390/27*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^3*lam2^3*
         z5 + 4151165/36*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]
         *lam1^3*lam2^3*z4 - 45690325/108*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam1^3*lam2^3*z3 - 980020/27*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^3*lam2^3*z3^2 - 57588665/
         432*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^4*
         lam2^2 - 2281370/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*lam1^4*lam2^2*z7 + 2116000/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*lam1^4*lam2^2*z6 - 19711090/81*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^4*lam2^2*z5 + 1022500/27*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*lam1^4*lam2^2*
         z4 - 3730340/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]
         *lam1^4*lam2^2*z3 - 188680/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1
         ,b2,phi1,phi1]*lam1^4*lam2^2*z3^2 + 39695/216*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^4 + 34250/9*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^4*z6 - 56590/
         9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^2*
         lam2^4*z5 + 6395/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*N*lam1^2*lam2^4*z4 - 11275/6*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^4*z3 + 8060/9*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^2*lam2^4*z3^2 - 3976975/
         2592*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^3*
         lam2^3 - 28910/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1
         ]*N*lam1^3*lam2^3*z7 + 308500/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^3*z6 - 588460/27*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^3*z5 + 236435/36*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^3
         *z4 - 1002625/108*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*N*lam1^3*lam2^3*z3 + 47080/27*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*N*lam1^3*lam2^3*z3^2 - 11475565/7776*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^4*lam2^2 - 42910/3*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^4*lam2^2
         *z7 + 77000/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N
         *lam1^4*lam2^2*z6 - 1562540/81*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b1,b2,phi1,phi1]*N*lam1^4*lam2^2*z5 + 537125/108*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^4*lam2^2*z4 - 3040445/324
         *delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N*lam1^4*
         lam2^2*z3 + 36520/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*N*lam1^4*lam2^2*z3^2 - 223825/15552*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^3*lam2^3 - 1645/27*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^3*lam2^3*z5 + 775/
         36*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^3*
         lam2^3*z4 + 20*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         N^2*lam1^3*lam2^3*z3 - 225695/7776*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,phi1,phi1]*N^2*lam1^4*lam2^2 + 4250/27*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^4*lam2^2*z6 - 28610/81*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^4*
         lam2^2*z5 + 695/6*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,
         phi1]*N^2*lam1^4*lam2^2*z4 - 1535/162*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b1,b2,phi1,phi1]*N^2*lam1^4*lam2^2*z3 + 340/9*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^2*lam1^4*lam2^2*z3^2 - 85/2592
         *delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*N^3*lam1^4*
         lam2^2 - 5/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,phi1,phi1]*
         N^3*lam1^4*lam2^2*z4 + 145/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b1,b2,phi1,phi1]*N^3*lam1^4*lam2^2*z3 - 62136905/23328*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^2*lam2^4 + 
         6625/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*
         lam1^2*lam2^4*z5 - 925*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,
         b3]*(phi1.phi1)*lam1^2*lam2^4*z4 - 5015/6*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^2*lam2^4*z3 + 120*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^2*lam2^4*z3^2
          - 26868335/15552*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*lam1^3*lam2^3 + 24675*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^3*z7 + 5750/9*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^3*z6 + 
         59915/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*lam1^3*lam2^3*z5 - 4585/12*delta[b1,b2,phi1,phi1,phi1,phi1
         ]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^3*z4 - 411280/27*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^3*lam2^3*z3
          - 8060/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*lam1^3*lam2^3*z3^2 + 6959935/3888*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^4*lam2^2 + 1614830/27*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^4*
         lam2^2*z7 + 66500/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]
         *(phi1.phi1)*lam1^4*lam2^2*z6 - 1539350/81*delta[b1,b2,phi1,phi1,phi1
         ,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^4*lam2^2*z5 + 27805/36*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^4*
         lam2^2*z4 - 5039905/324*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3
         ,b3]*(phi1.phi1)*lam1^4*lam2^2*z3 - 6640/9*delta[b1,b2,phi1,phi1,phi1
         ,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*lam1^4*lam2^2*z3^2 - 2201435/7776
         *delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N*
         lam1^3*lam2^3 + 35/6*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3
         ]*(phi1.phi1)*N*lam1^3*lam2^3*z4 + 5000/27*delta[b1,b2,phi1,phi1,phi1
         ,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N*lam1^3*lam2^3*z3 - 124522715/
         209952*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*
         N*lam1^4*lam2^2 - 10000/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b3,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z6 + 106790/81*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z5 + 
         10465/36*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(
         phi1.phi1)*N*lam1^4*lam2^2*z4 - 9535/36*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z3 - 1120/9*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N*lam1^4*
         lam2^2*z3^2 + 139565/69984*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2
         ,b3,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2 - 50/9*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2*z4 + 575/
         162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b1,b2,b3,b3]*(phi1.phi1)*N^2
         *lam1^4*lam2^2*z3 + 3413125/108*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*lam2^6 + 132300*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,phi1,b1,phi1]*lam2^6*z7 - 34500*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*lam2^6*z6 + 98680*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^6*z5 - 30375/2*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^6*z4 + 147145/3*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^6*z3 + 4680*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam2^6*z3^2 + 472029785/
         2592*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*
         lam2^5 + 655235*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *lam1*lam2^5*z7 - 496000/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*lam1*lam2^5*z6 + 1487125/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*lam1*lam2^5*z5 - 293175/4*delta[b1,b2,phi1
         ,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*lam2^5*z4 + 2990885/12*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1*lam2^5*z3
          + 79640/3*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1
         *lam2^5*z3^2 + 113183915/288*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*lam1^2*lam2^4 + 3728620/3*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^4*z7 - 301500*delta[b1,b2,phi1
         ,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^4*z6 + 8440630/9*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^4*
         z5 - 543385/4*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^2*lam2^4*z4 + 17363615/36*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*lam1^2*lam2^4*z3 + 154600/3*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^2*lam2^4*z3^2 + 2874119305/7776*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^3*lam2^3
          + 1005830*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^3*lam2^3*z7 - 6701750/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*lam1^3*lam2^3*z6 + 21295390/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^3*lam2^3*z5 - 4151165/36*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^3*lam2^3*z4 + 
         45690325/108*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^3*lam2^3*z3 + 980020/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*lam1^3*lam2^3*z3^2 + 57588665/432*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^4*lam2^2 + 2281370/9*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^4*lam2^2*z7 - 
         2116000/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^4*lam2^2*z6 + 19711090/81*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*lam1^4*lam2^2*z5 - 1022500/27*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^4*lam2^2*z4 + 3730340/27*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*lam1^4*lam2^2*z3 + 
         188680/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         lam1^4*lam2^2*z3^2 - 39695/216*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*N*lam1^2*lam2^4 - 34250/9*delta[b1,b2,phi1,phi1,phi1
         ,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^2*lam2^4*z6 + 56590/9*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^2*lam2^4*z5 - 6395/3
         *delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^2*
         lam2^4*z4 + 11275/6*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*N*lam1^2*lam2^4*z3 - 8060/9*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,phi1,b1,phi1]*N*lam1^2*lam2^4*z3^2 + 3976975/2592*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^3 + 28910/3*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^3
         *z7 - 308500/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *N*lam1^3*lam2^3*z6 + 588460/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,phi1,b1,phi1]*N*lam1^3*lam2^3*z5 - 236435/36*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^3*z4 + 1002625/108*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^3*lam2^3
         *z3 - 47080/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*
         N*lam1^3*lam2^3*z3^2 + 11475565/7776*delta[b1,b2,phi1,phi1,phi1,phi1]
         *D64[b2,phi1,b1,phi1]*N*lam1^4*lam2^2 + 42910/3*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^4*lam2^2*z7 - 77000/9*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^4*lam2^2*z6 + 
         1562540/81*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*
         lam1^4*lam2^2*z5 - 537125/108*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2
         ,phi1,b1,phi1]*N*lam1^4*lam2^2*z4 + 3040445/324*delta[b1,b2,phi1,phi1
         ,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^4*lam2^2*z3 - 36520/27*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N*lam1^4*lam2^2*z3^2
          + 223825/15552*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]
         *N^2*lam1^3*lam2^3 + 1645/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         phi1,b1,phi1]*N^2*lam1^3*lam2^3*z5 - 775/36*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^3*lam2^3*z4 - 20*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^3*lam2^3*z3 + 
         225695/7776*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2
         *lam1^4*lam2^2 - 4250/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1
         ,b1,phi1]*N^2*lam1^4*lam2^2*z6 + 28610/81*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^4*lam2^2*z5 - 695/6*delta[b1,b2,
         phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^4*lam2^2*z4 + 1535/
         162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^2*lam1^4*
         lam2^2*z3 - 340/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,
         phi1]*N^2*lam1^4*lam2^2*z3^2 + 85/2592*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,phi1,b1,phi1]*N^3*lam1^4*lam2^2 + 5/9*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^3*lam1^4*lam2^2*z4 - 145/162*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,phi1,b1,phi1]*N^3*lam1^4*
         lam2^2*z3 + 62136905/23328*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3
         ,b1,b3]*(phi1.phi1)*lam1^2*lam2^4 - 6625/9*delta[b1,b2,phi1,phi1,phi1
         ,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z5 + 925*delta[b1,
         b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z4
          + 5015/6*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*lam1^2*lam2^4*z3 - 120*delta[b1,b2,phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^2*lam2^4*z3^2 + 26868335/15552*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*
         lam2^3 - 24675*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^3*z7 - 5750/9*delta[b1,b2,phi1,phi1,phi1,phi1]
         *D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z6 - 59915/27*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z5
          + 4585/12*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*lam1^3*lam2^3*z4 + 411280/27*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*z3 + 8060/9*delta[b1
         ,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^3*lam2^3*
         z3^2 - 6959935/3888*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]
         *(phi1.phi1)*lam1^4*lam2^2 - 1614830/27*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^4*lam2^2*z7 - 66500/9*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^4*lam2^2
         *z6 + 1539350/81*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(
         phi1.phi1)*lam1^4*lam2^2*z5 - 27805/36*delta[b1,b2,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^4*lam2^2*z4 + 5039905/324*
         delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*lam1^4*
         lam2^2*z3 + 6640/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*
         (phi1.phi1)*lam1^4*lam2^2*z3^2 + 2201435/7776*delta[b1,b2,phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N*lam1^3*lam2^3 - 35/6*delta[
         b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N*lam1^3*
         lam2^3*z4 - 5000/27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]
         *(phi1.phi1)*N*lam1^3*lam2^3*z3 + 124522715/209952*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2 + 10000/
         27*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N*
         lam1^4*lam2^2*z6 - 106790/81*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         b3,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z5 - 10465/36*delta[b1,b2,phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z4 + 
         9535/36*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)
         *N*lam1^4*lam2^2*z3 + 1120/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,
         b3,b1,b3]*(phi1.phi1)*N*lam1^4*lam2^2*z3^2 - 139565/69984*delta[b1,b2
         ,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2
          + 50/9*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*(phi1.phi1)
         *N^2*lam1^4*lam2^2*z4 - 575/162*delta[b1,b2,phi1,phi1,phi1,phi1]*D64[
         b2,b3,b1,b3]*(phi1.phi1)*N^2*lam1^4*lam2^2*z3 + 9115/162*delta[b1,b2,
         ...
         *D64[b1,b2,b3,b3]*N^2*lam1^3*lam2^3*z3 + 127988575/23328*delta[b1,b2,
         phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1*lam2^5 + 2500*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1*
         lam2^5*z6 + 23240/3*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2
         ,b3,b1,b3]*lam1*lam2^5*z5 + 1885/2*delta[b1,b2,phi1,phi1,phi1,phi1,
         phi1,phi1]*D64[b2,b3,b1,b3]*lam1*lam2^5*z4 + 81115/9*delta[b1,b2,phi1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1*lam2^5*z3 + 2320*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1*
         lam2^5*z3^2 + 17764495/2592*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1
         ]*D64[b2,b3,b1,b3]*lam1^2*lam2^4 - 31500*delta[b1,b2,phi1,phi1,phi1,
         phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z7 + 41000/9*delta[b1,
         b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z6
          + 272890/9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,
         b3]*lam1^2*lam2^4*z5 + 10160/9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z4 + 2122805/54*delta[b1,b2,phi1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*lam2^4*z3 + 69200/
         9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^2*
         lam2^4*z3^2 - 14555185/11664*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3 - 562870/9*delta[b1,b2,phi1,phi1
         ,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*z7 - 14500/3*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*
         lam2^3*z6 + 1187630/27*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*lam1^3*lam2^3*z5 + 28220/27*delta[b1,b2,phi1,phi1,
         phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*lam2^3*z4 + 2695315/81*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*lam1^3*
         lam2^3*z3 + 58600/9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2
         ,b3,b1,b3]*lam1^3*lam2^3*z3^2 + 6889405/11664*delta[b1,b2,phi1,phi1,
         phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^2*lam2^4 - 280/9*delta[
         b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^2*lam2^4
         *z5 - 245/3*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,
         b3]*N*lam1^2*lam2^4*z4 - 9100/27*delta[b1,b2,phi1,phi1,phi1,phi1,phi1
         ,phi1]*D64[b2,b3,b1,b3]*N*lam1^2*lam2^4*z3 + 534896465/419904*delta[
         b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^3
          + 3250/9*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]
         *N*lam1^3*lam2^3*z6 - 15890/27*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,
         phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^3*z5 - 3940/9*delta[b1,b2,phi1,
         phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*lam1^3*lam2^3*z4 - 14515/
         324*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N*
         lam1^3*lam2^3*z3 + 260/3*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*
         D64[b2,b3,b1,b3]*N*lam1^3*lam2^3*z3^2 - 191995/17496*delta[b1,b2,phi1
         ,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N^2*lam1^3*lam2^3 + 80/9*
         delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]*D64[b2,b3,b1,b3]*N^2*
         lam1^3*lam2^3*z4 - 155/162*delta[b1,b2,phi1,phi1,phi1,phi1,phi1,phi1]
         *D64[b2,b3,b1,b3]*N^2*lam1^3*lam2^3*z3 - 12455/54*delta[b1,b2,b3,phi1
         ...
         *(phi1.phi1)*N*lam1^4*lam2*z5 - 2885/12*D66[b1,b1,phi1,phi1,phi1,phi1
         ...
         phi1.phi1)^3*lam1^5 + 130235/432*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*
         lam1^2*lam2^4 - 320/3*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^2*
         lam2^4*z5 + 70*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^2*lam2^4*z4 - 
         365/3*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^2*lam2^4*z3 + 4952165/
         5832*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*lam2^3 + 1000/3*D64[b1
         ,phi1,b1,phi1]*(phi1.phi1)^2*lam1^3*lam2^3*z6 - 5320/9*D64[b1,phi1,b1
         ,phi1]*(phi1.phi1)^2*lam1^3*lam2^3*z5 + 635/3*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^3*lam2^3*z4 - 13480/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^3*lam2^3*z3 - 80/3*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^3*lam2^3*z3^2 - 37789445/17496*D64[b1,phi1,b1,phi1]
         *(phi1.phi1)^2*lam1^4*lam2^2 - 64120/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z7 + 2000*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z6 - 166630/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z5 + 25855/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z4 - 356275/162*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z3 + 400*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^4*lam2^2*z3^2 - 216044135/23328*D64[b1,phi1,b1,phi1
         ]*(phi1.phi1)^2*lam1^5*lam2 - 2207800/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z7 + 259000/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z6 - 731260/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z5 + 62845/108*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z4 - 244915/324*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z3 - 37040/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^5*lam2*z3^2 - 62241545/11664*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^6 - 2452660/81*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*
         lam1^6*z7 + 8500/27*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^6*z6 - 
         110980/81*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^6*z5 - 20530/81*
         D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*lam1^6*z4 + 480685/243*D64[b1,phi1
         ,b1,phi1]*(phi1.phi1)^2*lam1^6*z3 - 16600/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*lam1^6*z3^2 + 866465/34992*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^4*lam2^2 - 280/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^4*lam2^2*z5 + 235/9*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^4*lam2^2*z4 - 950/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^4*lam2^2*z3 - 58274365/419904*D64[b1,phi1,b1,phi1
         ]*(phi1.phi1)^2*N*lam1^5*lam2 + 26000/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5*lam2*z6 - 105170/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5*lam2*z5 + 9935/54*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5*lam2*z4 - 92075/324*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5*lam2*z3 + 6560/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^5*lam2*z3^2 - 27217225/34992*D64[b1,phi1,b1,phi1]
         *(phi1.phi1)^2*N*lam1^6 - 678650/243*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^6*z7 + 52000/81*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^6*z6 - 374260/243*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N*lam1^6*z5 + 2165/54*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2
         *N*lam1^6*z4 - 13745/162*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N*lam1^6*
         z3 + 160/81*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N*lam1^6*z3^2 - 3715/
         4374*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*N^2*lam1^5*lam2 + 50/27*D64[
         b1,phi1,b1,phi1]*(phi1.phi1)^2*N^2*lam1^5*lam2*z4 + 20/27*D64[b1,phi1
         ,b1,phi1]*(phi1.phi1)^2*N^2*lam1^5*lam2*z3 - 2225015/209952*D64[b1,
         phi1,b1,phi1]*(phi1.phi1)^2*N^2*lam1^6 + 2000/81*D64[b1,phi1,b1,phi1]
         *(phi1.phi1)^2*N^2*lam1^6*z6 - 23360/243*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N^2*lam1^6*z5 + 505/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N^2*lam1^6*z4 - 2965/162*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N^2*lam1^6*z3 + 160/27*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N^2*lam1^6*z3^2 + 805/104976*D64[b1,phi1,b1,phi1]*(
         phi1.phi1)^2*N^3*lam1^6 + 25/243*D64[b1,phi1,b1,phi1]*(phi1.phi1)^2*
         ...
         *(phi1.phi1)^2*N^2*lam1^6*z6 + 23360/243*D64[b1,b1,phi1,phi1]*(
         ...
         N^3*lam1^6*z3 + 1024945/139968*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^4*
         lam2^2 - 5*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^4*lam2^2*z4 - 5195/108
         *D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^4*lam2^2*z3 - 53396795/209952*
         D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*lam2 + 4250/27*D64[b1,b2,b1,b2]
         *(phi1.phi1)^3*lam1^5*lam2*z6 - 1070*D64[b1,b2,b1,b2]*(phi1.phi1)^3*
         lam1^5*lam2*z5 - 145/9*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*lam2*z4
          - 1565/162*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*lam2*z3 + 3260/27*
         D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^5*lam2*z3^2 - 25824415/69984*D64[
         b1,b2,b1,b2]*(phi1.phi1)^3*lam1^6 - 430360/243*D64[b1,b2,b1,b2]*(
         phi1.phi1)^3*lam1^6*z7 + 1250/81*D64[b1,b2,b1,b2]*(phi1.phi1)^3*
         lam1^6*z6 - 77350/243*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^6*z5 - 2665/
         162*D64[b1,b2,b1,b2]*(phi1.phi1)^3*lam1^6*z4 + 34150/243*D64[b1,b2,b1
         ,b2]*(phi1.phi1)^3*lam1^6*z3 + 8900/81*D64[b1,b2,b1,b2]*(phi1.phi1)^3
         *lam1^6*z3^2 + 55615/69984*D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^5*
         lam2 + 5/6*D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^5*lam2*z4 - 85/54*
         D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^5*lam2*z3 - 4164535/209952*D64[
         b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^6 + 2500/81*D64[b1,b2,b1,b2]*(
         phi1.phi1)^3*N*lam1^6*z6 - 12500/81*D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*
         lam1^6*z5 - 55/27*D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^6*z4 + 895/81
         *D64[b1,b2,b1,b2]*(phi1.phi1)^3*N*lam1^6*z3 + 1000/81*D64[b1,b2,b1,b2
         ]*(phi1.phi1)^3*N*lam1^6*z3^2 + 5405/104976*D64[b1,b2,b1,b2]*(
