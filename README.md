...
Multi-loop anomalous dimensions in $4-2 \epsilon$ dimensions in various effective field theories. 
...
3. **Hypercubic theory.** A ϕ^4 theory with global $S_n \ltimes (Z_2)^n$ symmetry. We renormalize composite operators with general indices.
